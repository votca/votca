...
if (GROMACS_LIBRARY)
  ...
  if(FOUND_GROMACS_GMX_GPU_SHARING_SUPPORTED)
    set(GROMACS_VERSION 51)
  elseif(FOUND_GROMACS_INIT_DOMDEC_VSITES)
    set(GROMACS_VERSION 50)
  else()
    message(FATAL_ERROR "Could not find init_domdec_vsites nor gmx_gpu_sharing_supported in the gromacs library, take look at the error message in ${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeError.log to find out what was going wrong. This most likely means that your gromacs version is too old, we need at least gromacs 5 !") 
  endif()
...
find_package_handle_standard_args(GROMACS DEFAULT_MSG GROMACS_LIBRARY GROMACS_INCLUDE_DIR GROMACS_VERSION GROMACS_DEFINITIONS)

mark_as_advanced(GROMACS_LIBRARY GROMACS_INCLUDE_DIR GROMACS_VERSION GROMACS_DEFINITIONS)
