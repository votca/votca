...
if (GROMACS_LIBRARY)
  ...
  #if(${GROMACS_LIBRARY} MATCHES ".*lib[^/.]_d\\.[^.]*$" AND NOT GMX_DOUBLE)
  if(${GROMACS_LIBRARY} MATCHES "lib[^/]*_d\\.[^.]*$" AND NOT GMX_DOUBLE)
    message(WARNING "You are using ${GROMACS_LIBRARY}, which seems to be a double precision library. If this is not the case ignore this warning otherwise enable compling against double precision gromacs using -DGMX_DOUBLE=ON")
  endif()
