...
if (GROMACS_LIBRARY)
  ...
  if( ( (    ${GROMACS_LIBRARY} MATCHES "lib[^/]*_d\\.[^.]*$") AND (NOT "${GROMACS_PKG}" MATCHES "_d$") ) OR 
      ( (NOT ${GROMACS_LIBRARY} MATCHES "lib[^/]*_d\\.[^.]*$") AND (    "${GROMACS_PKG}" MATCHES "_d$") ) )
      message(WARNING "You are using ${GROMACS_LIBRARY}, but GROMACS_PKG was ${GROMACS_PKG}. There seems to be a mismatch in precision, single vs double, no ending vs. _d. If this is not the case ignore this warning otherwise enable set GROMACS_PKG correctly using -DGROMACS_PKG_OVERWRITE=lib(gmx|gromacs)(_d).")
  endif()
