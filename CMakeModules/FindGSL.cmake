...
option(GSL_USES_CBLAS "If GSL needs to be linked against cblas" OFF)
if (GSL_USES_CBLAS)
  find_library(GSLCBLAS_LIBRARY NAMES gslcblas cblas HINTS ${PC_GSL_LIBRARY_DIRS} )
  find_package_handle_standard_args(GSL DEFAULT_MSG GSLCBLAS_LIBRARY)
  if (GSL_FOUND)
  ...
  set(GSLCBLAS_LIBRARY)
endif (GSL_USES_CBLAS)
