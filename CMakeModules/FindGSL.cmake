...
#added gsl depends
#BUG in OpenSuse (missing libgslcblas.so link in libgsl.so)
#if (NOT BUILD_SHARED_LIBS and PC_GSL_LIBRARIES)
if (PC_GSL_LIBRARIES AND NOT GSL_DEP_LIBRARY)
  ...
  foreach (LIB ${PC_GSL_LIBRARIES})
    ...
    list(APPEND GSL_DEP_LIBRARY ${GSL_${LIB}})
    unset(GSL_${LIB} CACHE)
  endforeach(LIB)
  set(GSL_DEP_LIBRARY "${GSL_DEP_LIBRARY}" CACHE FILEPATH "GSL dep libs" FORCE)
endif (PC_GSL_LIBRARIES AND NOT GSL_DEP_LIBRARY)
...
find_package_handle_standard_args(GSL DEFAULT_MSG GSL_LIBRARY GSL_INCLUDE_DIR GSL_DEP_LIBRARY )

set(GSL_LIBRARIES "${GSL_LIBRARY};${GSL_DEP_LIBRARY}")
