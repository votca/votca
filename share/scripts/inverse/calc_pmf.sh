...
forcefile2="forces_${pullgroup0}_${pullgroup1}2.d"
potfile2="pmf_${pullgroup0}_${pullgroup1}2.d"
...
for sim in ${sims}; do
  ...
  force1="$(${CSGSHARE}/scripts/inverse/avg_bl.awk -v col=2 ${sim}/pullf.xvg | awk '/^[^#]/{print $1,$2}')"
