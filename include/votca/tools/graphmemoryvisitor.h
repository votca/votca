...
#ifndef VOTCA_TOOLS_GRAPHMEMORYVISITOR_H
#define VOTCA_TOOLS_GRAPHMEMORYVISITOR_H
 ...
 * It is built on top of the graph breadth first visitor. Unlike, the distance
 * visitor it will also record the order of traversal. As the visitor moves
...
#endif  // VOTCA_TOOLS_GRAPHMEMORYVISITOR_H
