...
namespace votca {
    namespace tools {
        ...
        public:
            ...
            Elements(): _filled_VdWChelpG(false),_filled_VdWMK(false),_filled_NucCrg(false),
                        _filled_CovRad(false),_filled_Mass(false),_filled_EleNum(false),
                        _filled_EleName(false),_filled_ElPolarizability(false),_filled_EleShort(false),
