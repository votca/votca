...
namespace votca { namespace ctp {
    ...
    public:
       ...
       ~PEwald3D3D();
        ...
        void Potential_ConvergeRealSpaceSum();
        void Potential_ConvergeReciprocalSpaceSum();
        void Potential_CalculateForegroundCorrection();
        void Potential_CalculateShapeCorrection();
