...
public:
    ...
    void Recompute_device(Bsumtree* non_injection_rates, Bsumtree* injection_rates);
...
void Vssmgroup::Recompute_device(Bsumtree* non_injection_rates, Bsumtree* injection_rates){
