...
public:
    ...
    void Recompute_device(Events* events, Bsumtree* non_injection_rates, Bsumtree* injection_rates);
    void Recompute_bulk(Events* events, Bsumtree* non_injection_rates);
    
    /// Obtain time step
    double Timestep(votca::tools::Random2 *RandomVariable);
    
    /// Choose event according to random number generated by random variable
    Event* Choose_event_device(Events* events, Bsumtree* non_injection_rates, Bsumtree* injection_rates, votca::tools::Random2 *RandomVariable);
...
void Vssmgroup::Recompute_device(Events* events, Bsumtree* non_injection_rates, Bsumtree* injection_rates){
...
void Vssmgroup::Recompute_bulk(Events* events, Bsumtree* non_injection_rates){

    tot_probsum = non_injection_rates->compute_sum();
}

Event* Vssmgroup::Choose_event_device(Events* events, Bsumtree* non_injection_rates, Bsumtree* injection_rates, votca::tools::Random2 *RandomVariable){
