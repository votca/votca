...
#ifndef _VOTCA_XTP_BSE_SINGLET_H
#define _VOTCA_XTP_BSE_SINGLET_H
...
class BSE_Singlet : public BSE_OPERATOR
{

	public:

		BSE_Singlet(Orbitals& orbitals,ctp::Logger &log,TCMatrix_gwbse& Mmn,const Eigen::MatrixXd& Hqp);
