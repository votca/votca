...
/**
    ...
    The Base Bead class describes the core functionality of an atom or a coarse grained bead. It stores information like the id, the name, the mass, the
...
public:   
     ...
     */
    const double &getMass() const { return _m; }
     ...
     */
    void setMass(const double &m) { _m=m; }
