...
\draw[tuborg, decoration={brace}] let \p1=(verify.north), \p2=(verify.south) in ($(2, \y1)$) -- ($(2, \y2)$) node[tubnode] {csg\_boltzmann to map\\Visualize reference + mapped in e.g. VMD};
