...
void NBList_3Body::Generate(BeadList &list1, BeadList &list2, BeadList &list3, bool do_exclusions)
{
    ...
    //builds neighbor lists for all cases, where all list are of different bead typess (list1 neq list2 neq list3),
    //list2 and list3 are of the same type (list1 neq (list2 = list3)) or all three lists are the same (list1=list2=list3)!
