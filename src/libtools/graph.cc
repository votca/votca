...
void Graph::setNode(std::pair<long int, GraphNode>& id_and_node) {
...
vector<pair<long int, GraphNode>> Graph::getNodes(void) const {
  vector<pair<long int, GraphNode>> vec_nodes;
  for (const pair<long int, GraphNode>& id_and_node : nodes_) {
...
void Graph::calcId_() {
  ...
  for (const pair<long int, GraphNode>& id_and_node : nodes) {
...
bool cmpVertNodePair(const pair<long int, GraphNode>& id_and_node1,
                     const pair<long int, GraphNode>& id_and_node2) {
