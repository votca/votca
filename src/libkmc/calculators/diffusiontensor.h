...
#ifndef __VOTCA_DIFFUSIONTENSOR_H
#define	__VOTCA_DIFFUSIONTENSOR_H
...
bool DiffusionTensor::EvaluateFrame()
{
    srand(_seed);
...
void DiffusionTensor::LoadGraph() {
...
#endif	/* __VOTCA_DIFFUSIONTENSOR_H */
