...
template <class T> class KSpace
{
    public:
         ...
         *                  part
         */
        KSpace( T alpha, T k_max ) : init( alpha, k_max ){}
        /*
         *
    ...
    private:
        ...
        T k_max;                    ///< floating-point version of the k-space cutoff
        int k_max_int;              ///< integer version of the k-space cutoff

        T pot_energy;               ///< potential energy computed for the k-space part
        std::vector<T> f;           ///< forces computed for the k-space part
        std::vector<T> tqe;         ///< torque computed for the k-space part
        ...
        /*
         *
         * Compute the cosine factors for the k-space part
         *
         */
};

template <class T> void KSpace::init_params( T _alpha, T _k_max )
{
    alpha = _alpha;
    k_max = _k_max;
