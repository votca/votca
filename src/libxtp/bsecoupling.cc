...
void BSECoupling::CalculateCouplings(const Orbitals& orbitalsA,
  ...
  CTP_LOG(ctp::logDEBUG, *_pLog)
      << ctp::TimeStamp() << "   molecule A has " << _bseA_singlet_exc
      << " singlet excitons with dimension " << _bseA_size << flush;
  CTP_LOG(ctp::logDEBUG, *_pLog)
      << ctp::TimeStamp() << "   molecule A has " << _bseA_triplet_exc
  ...
  CTP_LOG(ctp::logDEBUG, *_pLog)
      << ctp::TimeStamp() << "   molecule B has " << _bseB_singlet_exc
      << " singlet excitons with dimension " << _bseB_size << flush;
  CTP_LOG(ctp::logDEBUG, *_pLog)
      << ctp::TimeStamp() << "   molecule B has " << _bseB_triplet_exc
  ...
  CTP_LOG(ctp::logDEBUG, *_pLog)
      << ctp::TimeStamp() << "   levels used in BSE of molA: " << _bseA_vmin
      << " to " << _bseA_cmax << " total: " << _bseA_vtotal + _bseA_ctotal
      << flush;
  CTP_LOG(ctp::logDEBUG, *_pLog)
      << ctp::TimeStamp() << "   levels used in BSE of molB: " << _bseB_vmin
...
#pragma omp parallel for
  ...
  if (_doTriplets) {
    ...
    Eigen::MatrixXd Hamiltonian_AB = eh_s.cast<double>();
    CTP_LOG(ctp::logDEBUG, *_pLog)
        << ctp::TimeStamp() << "  Converted Hamiltonian to double" << flush;
    const Eigen::MatrixXd bseA_T =
