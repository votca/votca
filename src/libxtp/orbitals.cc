...
bool Orbitals::Load(string file_name) {
 ...
 ub::matrix<double> & Orbitals::TransitionDensityMatrix( ub::matrix<double>& _MOs , ub::matrix<real>& _BSECoefs, int state){
...
std::vector<ub::matrix<double> >& Orbitals::DensityMatrixExcitedState(ub::matrix<double>& _MOs, ub::matrix<real>& _BSECoefs, int state ){
    ...
    //int _bse_total = this->_bse_size;
     ...
     ub::matrix<real> _Acc = ub::zero_matrix<real>( this->_bse_ctotal , this->_bse_ctotal );
     ub::matrix<real> _Avv = ub::zero_matrix<real>( this->_bse_vtotal , this->_bse_vtotal );
