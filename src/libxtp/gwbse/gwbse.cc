...
namespace votca {
    namespace xtp {
        ...
        void GWBSE::Initialize(Property* options) {
            ...
            if (_do_qp_diag) {
                LOG(logDEBUG, *_pLog) << " qpdiag " << flush;
            }
            if (_do_bse_singlets) {
                LOG(logDEBUG, *_pLog) << " singlets " << flush;
            }
            if (_do_bse_triplets) {
                LOG(logDEBUG, *_pLog) << " triplets " << flush;
            }
            ...
            if (_store_eh_interaction) {
                LOG(logDEBUG, *_pLog) << " ehint " << flush;
            }
            ...
            if (_do_bse_singlets || _do_bse_triplets) {
                ...
                if (_do_bse_singlets && _do_bse_diag) {
                    ...
                    if (_do_full_BSE) {
                        ...
                        LOG(logDEBUG, *_pLog) << TimeStamp() << " Solved full BSE for singlets " << flush;
