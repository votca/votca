...
namespace votca { namespace xtp {
 ...
 int i_less_z[] = {  0,
        ...
        // some helpers
        double PmA0 = fak2*( decay_row * pos_row.getX() + decay_col * pos_col.getX() ) - pos_row.getX();
        double PmA1 = fak2*( decay_row * pos_row.getY() + decay_col * pos_col.getY() ) - pos_row.getY();
        double PmA2 = fak2*( decay_row * pos_row.getZ() + decay_col * pos_col.getZ() ) - pos_row.getZ();

        double PmB0 = fak2*( decay_row * pos_row.getX() + decay_col * pos_col.getX() ) - pos_col.getX();
        double PmB1 = fak2*( decay_row * pos_row.getY() + decay_col * pos_col.getY() ) - pos_col.getY();
        double PmB2 = fak2*( decay_row * pos_row.getZ() + decay_col * pos_col.getZ() ) - pos_col.getZ();

        double PmC0 = fak2*( decay_row * pos_row.getX() + decay_col * pos_col.getX() ) - position.getX();
        double PmC1 = fak2*( decay_row * pos_row.getY() + decay_col * pos_col.getY() ) - position.getY();
        double PmC2 = fak2*( decay_row * pos_row.getZ() + decay_col * pos_col.getZ() ) - position.getZ();
...
for (int m = 0; m < lsum+1; m++) {
  ...
  quad4[0][0][3][m] = (PmC0*PmC0 - PmC2*PmC2)*_prefactor_quad*FmU[m+2];
  quad4[0][0][4][m] = (PmC1*PmC1 - PmC2*PmC2)*_prefactor_quad*FmU[m+2];
}
//------------------------------------------------------
...
if (lmax_row > 0) {
  for (int m = 0; m < lsum; m++) {
    for (int k = 0; k < 5; k++) {
      quad4[Cart::x][0][k][m] = PmA0*quad4[0][0][k][m] - PmC0*quad4[0][0][k][m+1] + fac0[k]*dip4[0][0][ind0[k]][m+1];
      quad4[Cart::y][0][k][m] = PmA1*quad4[0][0][k][m] - PmC1*quad4[0][0][k][m+1] + fac1[k]*dip4[0][0][ind1[k]][m+1];
      quad4[Cart::z][0][k][m] = PmA2*quad4[0][0][k][m] - PmC2*quad4[0][0][k][m+1] + fac2[k]*dip4[0][0][ind2[k]][m+1];
    }
  }
}
//------------------------------------------------------
...
if (lmax_row > 1) {
  for (int m = 0; m < lsum-1; m++) {
    ...
    double term = fak*(quad4[0][0][k][m]-quad4[0][0][k][m+1]);
      quad4[Cart::xx][0][k][m] = PmA0*quad4[Cart::x][0][k][m] - PmC0*quad4[Cart::x][0][k][m+1] + fac0[k]*dip4[Cart::x][0][ind0[k]][m+1] + term;
      quad4[Cart::xy][0][k][m] = PmA0*quad4[Cart::y][0][k][m] - PmC0*quad4[Cart::y][0][k][m+1] + fac0[k]*dip4[Cart::y][0][ind0[k]][m+1];
      quad4[Cart::xz][0][k][m] = PmA0*quad4[Cart::z][0][k][m] - PmC0*quad4[Cart::z][0][k][m+1] + fac0[k]*dip4[Cart::z][0][ind0[k]][m+1];
      quad4[Cart::yy][0][k][m] = PmA1*quad4[Cart::y][0][k][m] - PmC1*quad4[Cart::y][0][k][m+1] + fac1[k]*dip4[Cart::y][0][ind1[k]][m+1] + term;
      quad4[Cart::yz][0][k][m] = PmA1*quad4[Cart::z][0][k][m] - PmC1*quad4[Cart::z][0][k][m+1] + fac1[k]*dip4[Cart::z][0][ind1[k]][m+1];
      quad4[Cart::zz][0][k][m] = PmA2*quad4[Cart::z][0][k][m] - PmC2*quad4[Cart::z][0][k][m+1] + fac2[k]*dip4[Cart::z][0][ind2[k]][m+1] + term;
    }
  }
}
//------------------------------------------------------
...
if (lmax_row > 2) {
  for (int m = 0; m < lsum-2; m++) {
    for (int k = 0; k < 5; k++) {
      quad4[Cart::xxx][0][k][m] = PmA0*quad4[Cart::xx][0][k][m] - PmC0*quad4[Cart::xx][0][k][m+1] + fac0[k]*dip4[Cart::xx][0][ind0[k]][m+1] + 2*fak*(quad4[Cart::x][0][k][m]-quad4[Cart::x][0][k][m+1]);
      quad4[Cart::xxy][0][k][m] = PmA1*quad4[Cart::xx][0][k][m] - PmC1*quad4[Cart::xx][0][k][m+1] + fac1[k]*dip4[Cart::xx][0][ind1[k]][m+1];
      quad4[Cart::xxz][0][k][m] = PmA2*quad4[Cart::xx][0][k][m] - PmC2*quad4[Cart::xx][0][k][m+1] + fac2[k]*dip4[Cart::xx][0][ind2[k]][m+1];
      quad4[Cart::xyy][0][k][m] = PmA0*quad4[Cart::yy][0][k][m] - PmC0*quad4[Cart::yy][0][k][m+1] + fac0[k]*dip4[Cart::yy][0][ind0[k]][m+1];
      quad4[Cart::xyz][0][k][m] = PmA0*quad4[Cart::yz][0][k][m] - PmC0*quad4[Cart::yz][0][k][m+1] + fac0[k]*dip4[Cart::yz][0][ind0[k]][m+1];
      quad4[Cart::xzz][0][k][m] = PmA0*quad4[Cart::zz][0][k][m] - PmC0*quad4[Cart::zz][0][k][m+1] + fac0[k]*dip4[Cart::zz][0][ind0[k]][m+1];
      quad4[Cart::yyy][0][k][m] = PmA1*quad4[Cart::yy][0][k][m] - PmC1*quad4[Cart::yy][0][k][m+1] + fac1[k]*dip4[Cart::yy][0][ind1[k]][m+1] + 2*fak*(quad4[Cart::y][0][k][m]-quad4[Cart::y][0][k][m+1]);
      quad4[Cart::yyz][0][k][m] = PmA2*quad4[Cart::yy][0][k][m] - PmC2*quad4[Cart::yy][0][k][m+1] + fac2[k]*dip4[Cart::yy][0][ind2[k]][m+1];
      quad4[Cart::yzz][0][k][m] = PmA1*quad4[Cart::zz][0][k][m] - PmC1*quad4[Cart::zz][0][k][m+1] + fac1[k]*dip4[Cart::zz][0][ind1[k]][m+1];
      quad4[Cart::zzz][0][k][m] = PmA2*quad4[Cart::zz][0][k][m] - PmC2*quad4[Cart::zz][0][k][m+1] + fac2[k]*dip4[Cart::zz][0][ind2[k]][m+1] + 2*fak*(quad4[Cart::z][0][k][m]-quad4[Cart::z][0][k][m+1]);
    }
  }
}
//------------------------------------------------------
...
if (lmax_row > 3) {
  for (int m = 0; m < lsum-3; m++) {
    ...
    quad4[Cart::xxxx][0][k][m] = PmA0*quad4[Cart::xxx][0][k][m] - PmC0*quad4[Cart::xxx][0][k][m+1] + fac0[k]*dip4[Cart::xxx][0][ind0[k]][m+1] + 3*term_xx;
    quad4[Cart::xxxy][0][k][m] = PmA1*quad4[Cart::xxx][0][k][m] - PmC1*quad4[Cart::xxx][0][k][m+1] + fac1[k]*dip4[Cart::xxx][0][ind1[k]][m+1];
    quad4[Cart::xxxz][0][k][m] = PmA2*quad4[Cart::xxx][0][k][m] - PmC2*quad4[Cart::xxx][0][k][m+1] + fac2[k]*dip4[Cart::xxx][0][ind2[k]][m+1];
    quad4[Cart::xxyy][0][k][m] = PmA0*quad4[Cart::xyy][0][k][m] - PmC0*quad4[Cart::xyy][0][k][m+1] + fac0[k]*dip4[Cart::xyy][0][ind0[k]][m+1] + term_yy;
    quad4[Cart::xxyz][0][k][m] = PmA1*quad4[Cart::xxz][0][k][m] - PmC1*quad4[Cart::xxz][0][k][m+1] + fac1[k]*dip4[Cart::xxz][0][ind1[k]][m+1];
    quad4[Cart::xxzz][0][k][m] = PmA0*quad4[Cart::xzz][0][k][m] - PmC0*quad4[Cart::xzz][0][k][m+1] + fac0[k]*dip4[Cart::xzz][0][ind0[k]][m+1] + term_zz;
    quad4[Cart::xyyy][0][k][m] = PmA0*quad4[Cart::yyy][0][k][m] - PmC0*quad4[Cart::yyy][0][k][m+1] + fac0[k]*dip4[Cart::yyy][0][ind0[k]][m+1];
    quad4[Cart::xyyz][0][k][m] = PmA0*quad4[Cart::yyz][0][k][m] - PmC0*quad4[Cart::yyz][0][k][m+1] + fac0[k]*dip4[Cart::yyz][0][ind0[k]][m+1];
    quad4[Cart::xyzz][0][k][m] = PmA0*quad4[Cart::yzz][0][k][m] - PmC0*quad4[Cart::yzz][0][k][m+1] + fac0[k]*dip4[Cart::yzz][0][ind0[k]][m+1];
    quad4[Cart::xzzz][0][k][m] = PmA0*quad4[Cart::zzz][0][k][m] - PmC0*quad4[Cart::zzz][0][k][m+1] + fac0[k]*dip4[Cart::zzz][0][ind0[k]][m+1];
    quad4[Cart::yyyy][0][k][m] = PmA1*quad4[Cart::yyy][0][k][m] - PmC1*quad4[Cart::yyy][0][k][m+1] + fac1[k]*dip4[Cart::yyy][0][ind1[k]][m+1] + 3*term_yy;
    quad4[Cart::yyyz][0][k][m] = PmA2*quad4[Cart::yyy][0][k][m] - PmC2*quad4[Cart::yyy][0][k][m+1] + fac2[k]*dip4[Cart::yyy][0][ind2[k]][m+1];
    quad4[Cart::yyzz][0][k][m] = PmA1*quad4[Cart::yzz][0][k][m] - PmC1*quad4[Cart::yzz][0][k][m+1] + fac1[k]*dip4[Cart::yzz][0][ind1[k]][m+1] + term_zz;
    quad4[Cart::yzzz][0][k][m] = PmA1*quad4[Cart::zzz][0][k][m] - PmC1*quad4[Cart::zzz][0][k][m+1] + fac1[k]*dip4[Cart::zzz][0][ind1[k]][m+1];
    quad4[Cart::zzzz][0][k][m] = PmA2*quad4[Cart::zzz][0][k][m] - PmC2*quad4[Cart::zzz][0][k][m+1] + fac2[k]*dip4[Cart::zzz][0][ind2[k]][m+1] + 3*term_zz;
    }
  }
}
//------------------------------------------------------
...
if (lmax_col > 0) {
  ...
  for (int m = 0; m < lmax_col; m++) {
    for (int k = 0; k < 5; k++) {
      quad4[0][Cart::x][k][m] = PmB0*quad4[0][0][k][m] - PmC0*quad4[0][0][k][m+1] + fac0[k]*dip4[0][0][ind0[k]][m+1];
      quad4[0][Cart::y][k][m] = PmB1*quad4[0][0][k][m] - PmC1*quad4[0][0][k][m+1] + fac1[k]*dip4[0][0][ind1[k]][m+1];
      quad4[0][Cart::z][k][m] = PmB2*quad4[0][0][k][m] - PmC2*quad4[0][0][k][m+1] + fac2[k]*dip4[0][0][ind2[k]][m+1];
    }
  }
  //------------------------------------------------------
  ...
  if (lmax_row > 0) {
    for (int m = 0; m < lmax_col; m++) {
      for (int i =  1; i < 4; i++) {
        for (int k = 0; k < 5; k++) {
          double term = fak*(quad4[0][0][k][m]-quad4[0][0][k][m+1]);
          quad4[i][Cart::x][k][m] = PmB0*quad4[i][0][k][m] - PmC0*quad4[i][0][k][m+1] + fac0[k]*dip4[i][0][ind0[k]][m+1] + nx[i]*term;
          quad4[i][Cart::y][k][m] = PmB1*quad4[i][0][k][m] - PmC1*quad4[i][0][k][m+1] + fac1[k]*dip4[i][0][ind1[k]][m+1] + ny[i]*term;
          quad4[i][Cart::z][k][m] = PmB2*quad4[i][0][k][m] - PmC2*quad4[i][0][k][m+1] + fac2[k]*dip4[i][0][ind2[k]][m+1] + nz[i]*term;
        }
      }
    }
  }
  ...
  for (int m = 0; m < lmax_col; m++) {
    for (int i = 4; i < n_orbitals[lmax_row]; i++) {
      ...
      int ilz_i = i_less_z[i];
      for (int k = 0; k < 5; k++) {
        quad4[i][Cart::x][k][m] = PmB0*quad4[i][0][k][m] - PmC0*quad4[i][0][k][m+1] + fac0[k]*dip4[i][0][ind0[k]][m+1] + nx_i*fak*(quad4[ilx_i][0][k][m] - quad4[ilx_i][0][k][m+1]);
        quad4[i][Cart::y][k][m] = PmB1*quad4[i][0][k][m] - PmC1*quad4[i][0][k][m+1] + fac1[k]*dip4[i][0][ind1[k]][m+1] + ny_i*fak*(quad4[ily_i][0][k][m] - quad4[ily_i][0][k][m+1]);
        quad4[i][Cart::z][k][m] = PmB2*quad4[i][0][k][m] - PmC2*quad4[i][0][k][m+1] + fac2[k]*dip4[i][0][ind2[k]][m+1] + nz_i*fak*(quad4[ilz_i][0][k][m] - quad4[ilz_i][0][k][m+1]);
      }
    }
  }
  //------------------------------------------------------
...
if (lmax_col > 1) {
  ...
  for (int m = 0; m < lmax_col-1; m++) {
    for (int k = 0; k < 5; k++) {
      double term = fak*(quad4[0][0][k][m]-quad4[0][0][k][m+1]);
      quad4[0][Cart::xx][k][m] = PmB0*quad4[0][Cart::x][k][m] - PmC0*quad4[0][Cart::x][k][m+1] + fac0[k]*dip4[0][Cart::x][ind0[k]][m+1] + term;
      quad4[0][Cart::xy][k][m] = PmB0*quad4[0][Cart::y][k][m] - PmC0*quad4[0][Cart::y][k][m+1] + fac0[k]*dip4[0][Cart::y][ind0[k]][m+1];
      quad4[0][Cart::xz][k][m] = PmB0*quad4[0][Cart::z][k][m] - PmC0*quad4[0][Cart::z][k][m+1] + fac0[k]*dip4[0][Cart::z][ind0[k]][m+1];
      quad4[0][Cart::yy][k][m] = PmB1*quad4[0][Cart::y][k][m] - PmC1*quad4[0][Cart::y][k][m+1] + fac1[k]*dip4[0][Cart::y][ind1[k]][m+1] + term;
      quad4[0][Cart::yz][k][m] = PmB1*quad4[0][Cart::z][k][m] - PmC1*quad4[0][Cart::z][k][m+1] + fac1[k]*dip4[0][Cart::z][ind1[k]][m+1];
      quad4[0][Cart::zz][k][m] = PmB2*quad4[0][Cart::z][k][m] - PmC2*quad4[0][Cart::z][k][m+1] + fac2[k]*dip4[0][Cart::z][ind2[k]][m+1] + term;
    }
  }
  //------------------------------------------------------
  ...
  for (int m = 0; m < lmax_col-1; m++) {
    for (int i = 1; i < n_orbitals[lmax_row]; i++) {
      ...
      for (int k = 0; k < 5; k++) {
        ...
        quad4[i][Cart::xx][k][m] = PmB0*quad4[i][Cart::x][k][m] - PmC0*quad4[i][Cart::x][k][m+1] + fac0[k]*dip4[i][Cart::x][ind0[k]][m+1]
                                    + nx_i*fak*(quad4[ilx_i][Cart::x][k][m] - quad4[ilx_i][Cart::x][k][m+1]) + term;
        quad4[i][Cart::xy][k][m] = PmB0*quad4[i][Cart::y][k][m] - PmC0*quad4[i][Cart::y][k][m+1] + fac0[k]*dip4[i][Cart::y][ind0[k]][m+1]
                                    + nx_i*fak*(quad4[ilx_i][Cart::y][k][m] - quad4[ilx_i][Cart::y][k][m+1]);
        quad4[i][Cart::xz][k][m] = PmB0*quad4[i][Cart::z][k][m] - PmC0*quad4[i][Cart::z][k][m+1] + fac0[k]*dip4[i][Cart::z][ind0[k]][m+1]
                                    + nx_i*fak*(quad4[ilx_i][Cart::z][k][m] - quad4[ilx_i][Cart::z][k][m+1]);
        quad4[i][Cart::yy][k][m] = PmB1*quad4[i][Cart::y][k][m] - PmC1*quad4[i][Cart::y][k][m+1] + fac1[k]*dip4[i][Cart::y][ind1[k]][m+1]
                                    + ny_i*fak*(quad4[ily_i][Cart::y][k][m] - quad4[ily_i][Cart::y][k][m+1]) + term;
        quad4[i][Cart::yz][k][m] = PmB1*quad4[i][Cart::z][k][m] - PmC1*quad4[i][Cart::z][k][m+1] + fac1[k]*dip4[i][Cart::z][ind1[k]][m+1]
                                    + ny_i*fak*(quad4[ily_i][Cart::z][k][m] - quad4[ily_i][Cart::z][k][m+1]);
        quad4[i][Cart::zz][k][m] = PmB2*quad4[i][Cart::z][k][m] - PmC2*quad4[i][Cart::z][k][m+1] + fac2[k]*dip4[i][Cart::z][ind2[k]][m+1]
...
if (lmax_col > 2) {
  ...
  for (int m = 0; m < lmax_col-2; m++) {
    for (int k = 0; k < 5; k++) {
      quad4[0][Cart::xxx][k][m] = PmB0*quad4[0][Cart::xx][k][m] - PmC0*quad4[0][Cart::xx][k][m+1] + fac0[k]*dip4[0][Cart::xx][ind0[k]][m+1] + 2*fak*(quad4[0][Cart::x][k][m]-quad4[0][Cart::x][k][m+1]);
      quad4[0][Cart::xxy][k][m] = PmB1*quad4[0][Cart::xx][k][m] - PmC1*quad4[0][Cart::xx][k][m+1] + fac1[k]*dip4[0][Cart::xx][ind1[k]][m+1];
      quad4[0][Cart::xxz][k][m] = PmB2*quad4[0][Cart::xx][k][m] - PmC2*quad4[0][Cart::xx][k][m+1] + fac2[k]*dip4[0][Cart::xx][ind2[k]][m+1];
      quad4[0][Cart::xyy][k][m] = PmB0*quad4[0][Cart::yy][k][m] - PmC0*quad4[0][Cart::yy][k][m+1] + fac0[k]*dip4[0][Cart::yy][ind0[k]][m+1];
      quad4[0][Cart::xyz][k][m] = PmB0*quad4[0][Cart::yz][k][m] - PmC0*quad4[0][Cart::yz][k][m+1] + fac0[k]*dip4[0][Cart::yz][ind0[k]][m+1];
      quad4[0][Cart::xzz][k][m] = PmB0*quad4[0][Cart::zz][k][m] - PmC0*quad4[0][Cart::zz][k][m+1] + fac0[k]*dip4[0][Cart::zz][ind0[k]][m+1];
      quad4[0][Cart::yyy][k][m] = PmB1*quad4[0][Cart::yy][k][m] - PmC1*quad4[0][Cart::yy][k][m+1] + fac1[k]*dip4[0][Cart::yy][ind1[k]][m+1] + 2*fak*(quad4[0][Cart::y][k][m]-quad4[0][Cart::y][k][m+1]);
      quad4[0][Cart::yyz][k][m] = PmB2*quad4[0][Cart::yy][k][m] - PmC2*quad4[0][Cart::yy][k][m+1] + fac2[k]*dip4[0][Cart::yy][ind2[k]][m+1];
      quad4[0][Cart::yzz][k][m] = PmB1*quad4[0][Cart::zz][k][m] - PmC1*quad4[0][Cart::zz][k][m+1] + fac1[k]*dip4[0][Cart::zz][ind1[k]][m+1];
      quad4[0][Cart::zzz][k][m] = PmB2*quad4[0][Cart::zz][k][m] - PmC2*quad4[0][Cart::zz][k][m+1] + fac2[k]*dip4[0][Cart::zz][ind2[k]][m+1] + 2*fak*(quad4[0][Cart::z][k][m]-quad4[0][Cart::z][k][m+1]);
    }
  }
  //------------------------------------------------------
  ...
  for (int m = 0; m < lmax_col-2; m++) {
    for (int i = 1; i < n_orbitals[lmax_row]; i++) {
      ...
      for (int k = 0; k < 5; k++) {
        ...
        quad4[i][Cart::xxx][k][m] = PmB0*quad4[i][Cart::xx][k][m] - PmC0*quad4[i][Cart::xx][k][m+1] + fac0[k]*dip4[i][Cart::xx][ind0[k]][m+1]
                                     + nx_i*fak*(quad4[ilx_i][Cart::xx][k][m] - quad4[ilx_i][Cart::xx][k][m+1]) + term_x;
        quad4[i][Cart::xxy][k][m] = PmB1*quad4[i][Cart::xx][k][m] - PmC1*quad4[i][Cart::xx][k][m+1] + fac1[k]*dip4[i][Cart::xx][ind1[k]][m+1]
                                     + ny_i*fak*(quad4[ily_i][Cart::xx][k][m] - quad4[ily_i][Cart::xx][k][m+1]);
        quad4[i][Cart::xxz][k][m] = PmB2*quad4[i][Cart::xx][k][m] - PmC2*quad4[i][Cart::xx][k][m+1] + fac2[k]*dip4[i][Cart::xx][ind2[k]][m+1]
                                     + nz_i*fak*(quad4[ilz_i][Cart::xx][k][m] - quad4[ilz_i][Cart::xx][k][m+1]);
        quad4[i][Cart::xyy][k][m] = PmB0*quad4[i][Cart::yy][k][m] - PmC0*quad4[i][Cart::yy][k][m+1] + fac0[k]*dip4[i][Cart::yy][ind0[k]][m+1]
                                     + nx_i*fak*(quad4[ilx_i][Cart::yy][k][m] - quad4[ilx_i][Cart::yy][k][m+1]);
        quad4[i][Cart::xyz][k][m] = PmB0*quad4[i][Cart::yz][k][m] - PmC0*quad4[i][Cart::yz][k][m+1] + fac0[k]*dip4[i][Cart::yz][ind0[k]][m+1]
                                     + nx_i*fak*(quad4[ilx_i][Cart::yz][k][m] - quad4[ilx_i][Cart::yz][k][m+1]);
        quad4[i][Cart::xzz][k][m] = PmB0*quad4[i][Cart::zz][k][m] - PmC0*quad4[i][Cart::zz][k][m+1] + fac0[k]*dip4[i][Cart::zz][ind0[k]][m+1]
                                     + nx_i*fak*(quad4[ilx_i][Cart::zz][k][m] - quad4[ilx_i][Cart::zz][k][m+1]);
        quad4[i][Cart::yyy][k][m] = PmB1*quad4[i][Cart::yy][k][m] - PmC1*quad4[i][Cart::yy][k][m+1] + fac1[k]*dip4[i][Cart::yy][ind1[k]][m+1]
                                     + ny_i*fak*(quad4[ily_i][Cart::yy][k][m] - quad4[ily_i][Cart::yy][k][m+1]) + term_y;
        quad4[i][Cart::yyz][k][m] = PmB2*quad4[i][Cart::yy][k][m] - PmC2*quad4[i][Cart::yy][k][m+1] + fac2[k]*dip4[i][Cart::yy][ind2[k]][m+1]
                                     + nz_i*fak*(quad4[ilz_i][Cart::yy][k][m] - quad4[ilz_i][Cart::yy][k][m+1]);
        quad4[i][Cart::yzz][k][m] = PmB1*quad4[i][Cart::zz][k][m] - PmC1*quad4[i][Cart::zz][k][m+1] + fac1[k]*dip4[i][Cart::zz][ind1[k]][m+1]
                                     + ny_i*fak*(quad4[ily_i][Cart::zz][k][m] - quad4[ily_i][Cart::zz][k][m+1]);
        quad4[i][Cart::zzz][k][m] = PmB2*quad4[i][Cart::zz][k][m] - PmC2*quad4[i][Cart::zz][k][m+1] + fac2[k]*dip4[i][Cart::zz][ind2[k]][m+1]
...
if (lmax_col > 3) {
  ...
  for (int m = 0; m < lmax_col-3; m++) {
    for (int k = 0; k < 5; k++) {
      ...
      quad4[0][Cart::xxxx][k][m] = PmB0*quad4[0][Cart::xxx][k][m] - PmC0*quad4[0][Cart::xxx][k][m+1] + fac0[k]*dip4[0][Cart::xxx][ind0[k]][m+1] + 3*term_xx;
      quad4[0][Cart::xxxy][k][m] = PmB1*quad4[0][Cart::xxx][k][m] - PmC1*quad4[0][Cart::xxx][k][m+1] + fac1[k]*dip4[0][Cart::xxx][ind1[k]][m+1];
      quad4[0][Cart::xxxz][k][m] = PmB2*quad4[0][Cart::xxx][k][m] - PmC2*quad4[0][Cart::xxx][k][m+1] + fac2[k]*dip4[0][Cart::xxx][ind2[k]][m+1];
      quad4[0][Cart::xxyy][k][m] = PmB0*quad4[0][Cart::xyy][k][m] - PmC0*quad4[0][Cart::xyy][k][m+1] + fac0[k]*dip4[0][Cart::xyy][ind0[k]][m+1] + term_yy;
      quad4[0][Cart::xxyz][k][m] = PmB1*quad4[0][Cart::xxz][k][m] - PmC1*quad4[0][Cart::xxz][k][m+1] + fac1[k]*dip4[0][Cart::xxz][ind1[k]][m+1];
      quad4[0][Cart::xxzz][k][m] = PmB0*quad4[0][Cart::xzz][k][m] - PmC0*quad4[0][Cart::xzz][k][m+1] + fac0[k]*dip4[0][Cart::xzz][ind0[k]][m+1] + term_zz;
      quad4[0][Cart::xyyy][k][m] = PmB0*quad4[0][Cart::yyy][k][m] - PmC0*quad4[0][Cart::yyy][k][m+1] + fac0[k]*dip4[0][Cart::yyy][ind0[k]][m+1];
      quad4[0][Cart::xyyz][k][m] = PmB0*quad4[0][Cart::yyz][k][m] - PmC0*quad4[0][Cart::yyz][k][m+1] + fac0[k]*dip4[0][Cart::yyz][ind0[k]][m+1];
      quad4[0][Cart::xyzz][k][m] = PmB0*quad4[0][Cart::yzz][k][m] - PmC0*quad4[0][Cart::yzz][k][m+1] + fac0[k]*dip4[0][Cart::yzz][ind0[k]][m+1];
      quad4[0][Cart::xzzz][k][m] = PmB0*quad4[0][Cart::zzz][k][m] - PmC0*quad4[0][Cart::zzz][k][m+1] + fac0[k]*dip4[0][Cart::zzz][ind0[k]][m+1];
      quad4[0][Cart::yyyy][k][m] = PmB1*quad4[0][Cart::yyy][k][m] - PmC1*quad4[0][Cart::yyy][k][m+1] + fac1[k]*dip4[0][Cart::yyy][ind1[k]][m+1] + 3*term_yy;
      quad4[0][Cart::yyyz][k][m] = PmB2*quad4[0][Cart::yyy][k][m] - PmC2*quad4[0][Cart::yyy][k][m+1] + fac2[k]*dip4[0][Cart::yyy][ind2[k]][m+1];
      quad4[0][Cart::yyzz][k][m] = PmB1*quad4[0][Cart::yzz][k][m] - PmC1*quad4[0][Cart::yzz][k][m+1] + fac1[k]*dip4[0][Cart::yzz][ind1[k]][m+1] + term_zz;
      quad4[0][Cart::yzzz][k][m] = PmB1*quad4[0][Cart::zzz][k][m] - PmC1*quad4[0][Cart::zzz][k][m+1] + fac1[k]*dip4[0][Cart::zzz][ind1[k]][m+1];
      quad4[0][Cart::zzzz][k][m] = PmB2*quad4[0][Cart::zzz][k][m] - PmC2*quad4[0][Cart::zzz][k][m+1] + fac2[k]*dip4[0][Cart::zzz][ind2[k]][m+1] + 3*term_zz;
    }
  }
  //------------------------------------------------------
  ...
  for (int m = 0; m < lmax_col-3; m++) {
    for (int i = 1; i < n_orbitals[lmax_row]; i++) {
      ...
      for (int k = 0; k < 5; k++) {
        ...
        quad4[i][Cart::xxxx][k][m] = PmB0*quad4[i][Cart::xxx][k][m] - PmC0*quad4[i][Cart::xxx][k][m+1] + fac0[k]*dip4[i][Cart::xxx][ind0[k]][m+1]
                                      + nx_i*fak*(quad4[ilx_i][Cart::xxx][k][m] - quad4[ilx_i][Cart::xxx][k][m+1]) + 3*term_xx;
        quad4[i][Cart::xxxy][k][m] = PmB1*quad4[i][Cart::xxx][k][m] - PmC1*quad4[i][Cart::xxx][k][m+1] + fac1[k]*dip4[i][Cart::xxx][ind1[k]][m+1]
                                      + ny_i*fak*(quad4[ily_i][Cart::xxx][k][m] - quad4[ily_i][Cart::xxx][k][m+1]);
        quad4[i][Cart::xxxz][k][m] = PmB2*quad4[i][Cart::xxx][k][m] - PmC2*quad4[i][Cart::xxx][k][m+1] + fac2[k]*dip4[i][Cart::xxx][ind2[k]][m+1]
                                      + nz_i*fak*(quad4[ilz_i][Cart::xxx][k][m] - quad4[ilz_i][Cart::xxx][k][m+1]);
        quad4[i][Cart::xxyy][k][m] = PmB0*quad4[i][Cart::xyy][k][m] - PmC0*quad4[i][Cart::xyy][k][m+1] + fac0[k]*dip4[i][Cart::xyy][ind0[k]][m+1]
                                      + nx_i*fak*(quad4[ilx_i][Cart::xyy][k][m] - quad4[ilx_i][Cart::xyy][k][m+1]) + term_yy;
        quad4[i][Cart::xxyz][k][m] = PmB1*quad4[i][Cart::xxz][k][m] - PmC1*quad4[i][Cart::xxz][k][m+1] + fac1[k]*dip4[i][Cart::xxz][ind1[k]][m+1]
                                      + ny_i*fak*(quad4[ily_i][Cart::xxz][k][m] - quad4[ily_i][Cart::xxz][k][m+1]);
        quad4[i][Cart::xxzz][k][m] = PmB0*quad4[i][Cart::xzz][k][m] - PmC0*quad4[i][Cart::xzz][k][m+1] + fac0[k]*dip4[i][Cart::xzz][ind0[k]][m+1]
                                      + nx_i*fak*(quad4[ilx_i][Cart::xzz][k][m] - quad4[ilx_i][Cart::xzz][k][m+1]) + term_zz;
        quad4[i][Cart::xyyy][k][m] = PmB0*quad4[i][Cart::yyy][k][m] - PmC0*quad4[i][Cart::yyy][k][m+1] + fac0[k]*dip4[i][Cart::yyy][ind0[k]][m+1]
                                      + nx_i*fak*(quad4[ilx_i][Cart::yyy][k][m] - quad4[ilx_i][Cart::yyy][k][m+1]);
        quad4[i][Cart::xyyz][k][m] = PmB0*quad4[i][Cart::yyz][k][m] - PmC0*quad4[i][Cart::yyz][k][m+1] + fac0[k]*dip4[i][Cart::yyz][ind0[k]][m+1]
                                      + nx_i*fak*(quad4[ilx_i][Cart::yyz][k][m] - quad4[ilx_i][Cart::yyz][k][m+1]);
        quad4[i][Cart::xyzz][k][m] = PmB0*quad4[i][Cart::yzz][k][m] - PmC0*quad4[i][Cart::yzz][k][m+1] + fac0[k]*dip4[i][Cart::yzz][ind0[k]][m+1]
                                      + nx_i*fak*(quad4[ilx_i][Cart::yzz][k][m] - quad4[ilx_i][Cart::yzz][k][m+1]);
        quad4[i][Cart::xzzz][k][m] = PmB0*quad4[i][Cart::zzz][k][m] - PmC0*quad4[i][Cart::zzz][k][m+1] + fac0[k]*dip4[i][Cart::zzz][ind0[k]][m+1]
                                      + nx_i*fak*(quad4[ilx_i][Cart::zzz][k][m] - quad4[ilx_i][Cart::zzz][k][m+1]);
        quad4[i][Cart::yyyy][k][m] = PmB1*quad4[i][Cart::yyy][k][m] - PmC1*quad4[i][Cart::yyy][k][m+1] + fac1[k]*dip4[i][Cart::yyy][ind1[k]][m+1]
                                      + ny_i*fak*(quad4[ily_i][Cart::yyy][k][m] - quad4[ily_i][Cart::yyy][k][m+1]) + 3*term_yy;
        quad4[i][Cart::yyyz][k][m] = PmB2*quad4[i][Cart::yyy][k][m] - PmC2*quad4[i][Cart::yyy][k][m+1] + fac2[k]*dip4[i][Cart::yyy][ind2[k]][m+1]
                                      + nz_i*fak*(quad4[ilz_i][Cart::yyy][k][m] - quad4[ilz_i][Cart::yyy][k][m+1]);
        quad4[i][Cart::yyzz][k][m] = PmB1*quad4[i][Cart::yzz][k][m] - PmC1*quad4[i][Cart::yzz][k][m+1] + fac1[k]*dip4[i][Cart::yzz][ind1[k]][m+1]
                                      + ny_i*fak*(quad4[ily_i][Cart::yzz][k][m] - quad4[ily_i][Cart::yzz][k][m+1]) + term_zz;
        quad4[i][Cart::yzzz][k][m] = PmB1*quad4[i][Cart::zzz][k][m] - PmC1*quad4[i][Cart::zzz][k][m+1] + fac1[k]*dip4[i][Cart::zzz][ind1[k]][m+1]
                                      + ny_i*fak*(quad4[ily_i][Cart::zzz][k][m] - quad4[ily_i][Cart::zzz][k][m+1]);
        quad4[i][Cart::zzzz][k][m] = PmB2*quad4[i][Cart::zzz][k][m] - PmC2*quad4[i][Cart::zzz][k][m+1] + fac2[k]*dip4[i][Cart::zzz][ind2[k]][m+1]
...
for (int i = 0; i < nrows; i++) {
  for (int j = 0; j < ncols; j++) {
    quad(i,j) = q_01 * quad4[i][j][0][0] + q_02 * quad4[i][j][1][0] + q_12 * quad4[i][j][2][0]
        ...
        void AOQuadrupole_Potential::Fillextpotential(const AOBasis& aobasis, const std::vector<std::shared_ptr<xtp::PolarSeg> > & sites) {
