...
void AODipole::FillBlock(std::vector<Eigen::Block<Eigen::MatrixXd> >& matrix,
  ...
  if (lmax_col > 4) {
    std::cerr << "Momentum transition dipoles only implemented for S,P,D,F,G "
                 "functions in DFT basis!"
              << std::flush;
    exit(1);
  }
    ...
    for (AOShell::GaussianIterator itc = shell_col->begin();
      ...
      if (lmax_row > 1) {
        for (int k = 0; k < 3; k++) {
          ...
          dip[k](Cart::xx, 0) = PmA0 * dip[k](Cart::x, 0) +
                                (k == 0) * fak * ol(Cart::x, 0) + term;
          dip[k](Cart::xy, 0) =
              PmA0 * dip[k](Cart::y, 0) + (k == 0) * fak * ol(Cart::y, 0);
          dip[k](Cart::xz, 0) =
              PmA0 * dip[k](Cart::z, 0) + (k == 0) * fak * ol(Cart::z, 0);
          dip[k](Cart::yy, 0) = PmA1 * dip[k](Cart::y, 0) +
                                (k == 1) * fak * ol(Cart::y, 0) + term;
          dip[k](Cart::yz, 0) =
              PmA1 * dip[k](Cart::z, 0) + (k == 1) * fak * ol(Cart::z, 0);
          dip[k](Cart::zz, 0) = PmA2 * dip[k](Cart::z, 0) +
      ...
      if (lmax_row > 2) {
        for (int k = 0; k < 3; k++) {
          dip[k](Cart::xxx, 0) = PmA0 * dip[k](Cart::xx, 0) +
                                 (k == 0) * fak * ol(Cart::xx, 0) +
                                 2 * fak * dip[k](Cart::x, 0);
          dip[k](Cart::xxy, 0) =
              PmA1 * dip[k](Cart::xx, 0) + (k == 1) * fak * ol(Cart::xx, 0);
          dip[k](Cart::xxz, 0) =
              PmA2 * dip[k](Cart::xx, 0) + (k == 2) * fak * ol(Cart::xx, 0);
          dip[k](Cart::xyy, 0) =
              PmA0 * dip[k](Cart::yy, 0) + (k == 0) * fak * ol(Cart::yy, 0);
          dip[k](Cart::xyz, 0) =
              PmA0 * dip[k](Cart::yz, 0) + (k == 0) * fak * ol(Cart::yz, 0);
          dip[k](Cart::xzz, 0) =
              PmA0 * dip[k](Cart::zz, 0) + (k == 0) * fak * ol(Cart::zz, 0);
          dip[k](Cart::yyy, 0) = PmA1 * dip[k](Cart::yy, 0) +
                                 (k == 1) * fak * ol(Cart::yy, 0) +
                                 2 * fak * dip[k](Cart::y, 0);
          dip[k](Cart::yyz, 0) =
              PmA2 * dip[k](Cart::yy, 0) + (k == 2) * fak * ol(Cart::yy, 0);
          dip[k](Cart::yzz, 0) =
              PmA1 * dip[k](Cart::zz, 0) + (k == 1) * fak * ol(Cart::zz, 0);
          dip[k](Cart::zzz, 0) = PmA2 * dip[k](Cart::zz, 0) +
      ...
      if (lmax_row > 3) {
        for (int k = 0; k < 3; k++) {
          ...
          dip[k](Cart::xxxx, 0) = PmA0 * dip[k](Cart::xxx, 0) +
                                  (k == 0) * fak * ol(Cart::xxx, 0) +
                                  3 * term_xx;
          dip[k](Cart::xxxy, 0) =
              PmA1 * dip[k](Cart::xxx, 0) + (k == 1) * fak * ol(Cart::xxx, 0);
          dip[k](Cart::xxxz, 0) =
              PmA2 * dip[k](Cart::xxx, 0) + (k == 2) * fak * ol(Cart::xxx, 0);
          dip[k](Cart::xxyy, 0) = PmA0 * dip[k](Cart::xyy, 0) +
                                  (k == 0) * fak * ol(Cart::xyy, 0) + term_yy;
          dip[k](Cart::xxyz, 0) =
              PmA1 * dip[k](Cart::xxz, 0) + (k == 1) * fak * ol(Cart::xxz, 0);
          dip[k](Cart::xxzz, 0) = PmA0 * dip[k](Cart::xzz, 0) +
                                  (k == 0) * fak * ol(Cart::xzz, 0) + term_zz;
          dip[k](Cart::xyyy, 0) =
              PmA0 * dip[k](Cart::yyy, 0) + (k == 0) * fak * ol(Cart::yyy, 0);
          dip[k](Cart::xyyz, 0) =
              PmA0 * dip[k](Cart::yyz, 0) + (k == 0) * fak * ol(Cart::yyz, 0);
          dip[k](Cart::xyzz, 0) =
              PmA0 * dip[k](Cart::yzz, 0) + (k == 0) * fak * ol(Cart::yzz, 0);
          dip[k](Cart::xzzz, 0) =
              PmA0 * dip[k](Cart::zzz, 0) + (k == 0) * fak * ol(Cart::zzz, 0);
          dip[k](Cart::yyyy, 0) = PmA1 * dip[k](Cart::yyy, 0) +
                                  (k == 1) * fak * ol(Cart::yyy, 0) +
                                  3 * term_yy;
          dip[k](Cart::yyyz, 0) =
              PmA2 * dip[k](Cart::yyy, 0) + (k == 2) * fak * ol(Cart::yyy, 0);
          dip[k](Cart::yyzz, 0) = PmA1 * dip[k](Cart::yzz, 0) +
                                  (k == 1) * fak * ol(Cart::yzz, 0) + term_zz;
          dip[k](Cart::yzzz, 0) =
              PmA1 * dip[k](Cart::zzz, 0) + (k == 1) * fak * ol(Cart::zzz, 0);
          dip[k](Cart::zzzz, 0) = PmA2 * dip[k](Cart::zzz, 0) +
      ...
      if (lmax_col > 0) {
        ...
        for (int i = 1; i < n_orbitals[lmax_row]; i++) {
          for (int k = 0; k < 3; k++) {
            dip[k](i, Cart::x) = PmB0 * dip[k](i, 0) +
                                 (k == 0) * fak * ol(i, 0) +
                                 nx[i] * fak * dip[k](i_less_x[i], 0);
            dip[k](i, Cart::y) = PmB1 * dip[k](i, 0) +
                                 (k == 1) * fak * ol(i, 0) +
                                 ny[i] * fak * dip[k](i_less_y[i], 0);
            dip[k](i, Cart::z) = PmB2 * dip[k](i, 0) +
                                 (k == 2) * fak * ol(i, 0) +
      ...
      if (lmax_col > 1) {
        ...
        for (int k = 0; k < 3; k++) {
          double term = fak * dip[k](0, 0);
          dip[k](0, Cart::xx) = PmB0 * dip[k](0, Cart::x) +
                                (k == 0) * fak * ol(0, Cart::x) + term;
          dip[k](0, Cart::xy) =
              PmB0 * dip[k](0, Cart::y) + (k == 0) * fak * ol(0, Cart::y);
          dip[k](0, Cart::xz) =
              PmB0 * dip[k](0, Cart::z) + (k == 0) * fak * ol(0, Cart::z);
          dip[k](0, Cart::yy) = PmB1 * dip[k](0, Cart::y) +
                                (k == 1) * fak * ol(0, Cart::y) + term;
          dip[k](0, Cart::yz) =
              PmB1 * dip[k](0, Cart::z) + (k == 1) * fak * ol(0, Cart::z);
          dip[k](0, Cart::zz) = PmB2 * dip[k](0, Cart::z) +
        ...
        for (int i = 1; i < n_orbitals[lmax_row]; i++) {
          for (int k = 0; k < 3; k++) {
            ...
            dip[k](i, Cart::xx) =
                PmB0 * dip[k](i, Cart::x) + (k == 0) * fak * ol(i, Cart::x) +
                nx[i] * fak * dip[k](i_less_x[i], Cart::x) + term;
            dip[k](i, Cart::xy) = PmB0 * dip[k](i, Cart::y) +
                                  (k == 0) * fak * ol(i, Cart::y) +
                                  nx[i] * fak * dip[k](i_less_x[i], Cart::y);
            dip[k](i, Cart::xz) = PmB0 * dip[k](i, Cart::z) +
                                  (k == 0) * fak * ol(i, Cart::z) +
                                  nx[i] * fak * dip[k](i_less_x[i], Cart::z);
            dip[k](i, Cart::yy) =
                PmB1 * dip[k](i, Cart::y) + (k == 1) * fak * ol(i, Cart::y) +
                ny[i] * fak * dip[k](i_less_y[i], Cart::y) + term;
            dip[k](i, Cart::yz) = PmB1 * dip[k](i, Cart::z) +
                                  (k == 1) * fak * ol(i, Cart::z) +
                                  ny[i] * fak * dip[k](i_less_y[i], Cart::z);
            dip[k](i, Cart::zz) =
                PmB2 * dip[k](i, Cart::z) + (k == 2) * fak * ol(i, Cart::z) +
      ...
      if (lmax_col > 2) {
        ...
        // Integrals     s - f
        for (int k = 0; k < 3; k++) {
          dip[k](0, Cart::xxx) = PmB0 * dip[k](0, Cart::xx) +
                                 (k == 0) * fak * ol(0, Cart::xx) +
                                 2 * fak * dip[k](0, Cart::x);
          dip[k](0, Cart::xxy) =
              PmB1 * dip[k](0, Cart::xx) + (k == 1) * fak * ol(0, Cart::xx);
          dip[k](0, Cart::xxz) =
              PmB2 * dip[k](0, Cart::xx) + (k == 2) * fak * ol(0, Cart::xx);
          dip[k](0, Cart::xyy) =
              PmB0 * dip[k](0, Cart::yy) + (k == 0) * fak * ol(0, Cart::yy);
          dip[k](0, Cart::xyz) =
              PmB0 * dip[k](0, Cart::yz) + (k == 0) * fak * ol(0, Cart::yz);
          dip[k](0, Cart::xzz) =
              PmB0 * dip[k](0, Cart::zz) + (k == 0) * fak * ol(0, Cart::zz);
          dip[k](0, Cart::yyy) = PmB1 * dip[k](0, Cart::yy) +
                                 (k == 1) * fak * ol(0, Cart::yy) +
                                 2 * fak * dip[k](0, Cart::y);
          dip[k](0, Cart::yyz) =
              PmB2 * dip[k](0, Cart::yy) + (k == 2) * fak * ol(0, Cart::yy);
          dip[k](0, Cart::yzz) =
              PmB1 * dip[k](0, Cart::zz) + (k == 1) * fak * ol(0, Cart::zz);
          dip[k](0, Cart::zzz) = PmB2 * dip[k](0, Cart::zz) +
        ...
        for (int i = 1; i < n_orbitals[lmax_row]; i++) {
          for (int k = 0; k < 3; k++) {
            ...
            dip[k](i, Cart::xxx) =
                PmB0 * dip[k](i, Cart::xx) + (k == 0) * fak * ol(i, Cart::xx) +
                nx[i] * fak * dip[k](i_less_x[i], Cart::xx) + term_x;
            dip[k](i, Cart::xxy) = PmB1 * dip[k](i, Cart::xx) +
                                   (k == 1) * fak * ol(i, Cart::xx) +
                                   ny[i] * fak * dip[k](i_less_y[i], Cart::xx);
            dip[k](i, Cart::xxz) = PmB2 * dip[k](i, Cart::xx) +
                                   (k == 2) * fak * ol(i, Cart::xx) +
                                   nz[i] * fak * dip[k](i_less_z[i], Cart::xx);
            dip[k](i, Cart::xyy) = PmB0 * dip[k](i, Cart::yy) +
                                   (k == 0) * fak * ol(i, Cart::yy) +
                                   nx[i] * fak * dip[k](i_less_x[i], Cart::yy);
            dip[k](i, Cart::xyz) = PmB0 * dip[k](i, Cart::yz) +
                                   (k == 0) * fak * ol(i, Cart::yz) +
                                   nx[i] * fak * dip[k](i_less_x[i], Cart::yz);
            dip[k](i, Cart::xzz) = PmB0 * dip[k](i, Cart::zz) +
                                   (k == 0) * fak * ol(i, Cart::zz) +
                                   nx[i] * fak * dip[k](i_less_x[i], Cart::zz);
            dip[k](i, Cart::yyy) =
                PmB1 * dip[k](i, Cart::yy) + (k == 1) * fak * ol(i, Cart::yy) +
                ny[i] * fak * dip[k](i_less_y[i], Cart::yy) + term_y;
            dip[k](i, Cart::yyz) = PmB2 * dip[k](i, Cart::yy) +
                                   (k == 2) * fak * ol(i, Cart::yy) +
                                   nz[i] * fak * dip[k](i_less_z[i], Cart::yy);
            dip[k](i, Cart::yzz) = PmB1 * dip[k](i, Cart::zz) +
                                   (k == 1) * fak * ol(i, Cart::zz) +
                                   ny[i] * fak * dip[k](i_less_y[i], Cart::zz);
            dip[k](i, Cart::zzz) =
                PmB2 * dip[k](i, Cart::zz) + (k == 2) * fak * ol(i, Cart::zz) +
                nz[i] * fak * dip[k](i_less_z[i], Cart::zz) + term_z;
          }
        }
        //------------------------------------------------------
      ...
      if (lmax_col > 3) {
        ...
        for (int k = 0; k < 3; k++) {
          ...
          dip[k](0, Cart::xxxx) = PmB0 * dip[k](0, Cart::xxx) +
                                  (k == 0) * fak * ol(0, Cart::xxx) +
                                  3 * term_xx;
          dip[k](0, Cart::xxxy) =
              PmB1 * dip[k](0, Cart::xxx) + (k == 1) * fak * ol(0, Cart::xxx);
          dip[k](0, Cart::xxxz) =
              PmB2 * dip[k](0, Cart::xxx) + (k == 2) * fak * ol(0, Cart::xxx);
          dip[k](0, Cart::xxyy) = PmB0 * dip[k](0, Cart::xyy) +
                                  (k == 0) * fak * ol(0, Cart::xyy) + term_yy;
          dip[k](0, Cart::xxyz) =
              PmB1 * dip[k](0, Cart::xxz) + (k == 1) * fak * ol(0, Cart::xxz);
          dip[k](0, Cart::xxzz) = PmB0 * dip[k](0, Cart::xzz) +
                                  (k == 0) * fak * ol(0, Cart::xzz) + term_zz;
          dip[k](0, Cart::xyyy) =
              PmB0 * dip[k](0, Cart::yyy) + (k == 0) * fak * ol(0, Cart::yyy);
          dip[k](0, Cart::xyyz) =
              PmB0 * dip[k](0, Cart::yyz) + (k == 0) * fak * ol(0, Cart::yyz);
          dip[k](0, Cart::xyzz) =
              PmB0 * dip[k](0, Cart::yzz) + (k == 0) * fak * ol(0, Cart::yzz);
          dip[k](0, Cart::xzzz) =
              PmB0 * dip[k](0, Cart::zzz) + (k == 0) * fak * ol(0, Cart::zzz);
          dip[k](0, Cart::yyyy) = PmB1 * dip[k](0, Cart::yyy) +
                                  (k == 1) * fak * ol(0, Cart::yyy) +
                                  3 * term_yy;
          dip[k](0, Cart::yyyz) =
              PmB2 * dip[k](0, Cart::yyy) + (k == 2) * fak * ol(0, Cart::yyy);
          dip[k](0, Cart::yyzz) = PmB1 * dip[k](0, Cart::yzz) +
                                  (k == 1) * fak * ol(0, Cart::yzz) + term_zz;
          dip[k](0, Cart::yzzz) =
              PmB1 * dip[k](0, Cart::zzz) + (k == 1) * fak * ol(0, Cart::zzz);
          dip[k](0, Cart::zzzz) = PmB2 * dip[k](0, Cart::zzz) +
