...
std::array<int, 6> AOTransform::nx() {
...
std::array<int, 6> AOTransform::ny() {
...
std::array<int, 6> AOTransform::nz() {
...
std::array<int, 6> AOTransform::i_less_x() {
...
std::array<int, 6> AOTransform::i_less_y() {
...
std::array<int, 6>
    AOTransform::
        i_less_z(){
            return 0, 0,   0,   0,   0,   0,   1,   0,   2,   3,   0,   0,
                   4,        0,   5,   6,   0,   7,   8,   9,   0,   0,   10,  0,
                   11,       12,  0,   13,  14,  15,  0,   16,  17,  18,  19,  0,
                   0,        20,  0,   21,  22,  0,   23,  24,  25,  0,   26,  27,
                   28,       29,  0,   30,  31,  32,  33,  34,  0,   0,   35,  0,
                   36,       37,  0,   38,  39,  40,  0,   41,  42,  43,  44,  0,
                   45,       46,  47,  48,  49,  0,   50,  51,  52,  53,  54,  55,
                   0,        0,   56,  0,   57,  58,  0,   59,  60,  61,  0,   62,
                   63,       64,  65,  0,   66,  67,  68,  69,  70,  0,   71,  72,
                   73,       74,  75,  76,  0,   77,  78,  79,  80,  81,  82,  83,
                   0,        0,   84,  0,   85,  86,  0,   87,  88,  89,  0,   90,
                   91,       92,  93,  0,   94,  95,  96,  97,  98,  0,   99,  100,
                   101,      102, 103, 104, 0,   105, 106, 107, 108, 109, 110, 111,
                   0,        112, 113, 114, 115, 116, 117, 118, 119};
}  // namespace xtp

std::array<int, 6> AOTransform::i_more_x() {
  ...
  std::array<int, 6> AOTransform::i_more_y() {
    ...
    std::array<int, 6> AOTransform::i_more_z() {
