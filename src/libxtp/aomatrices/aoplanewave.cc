                  ...
                  for (const auto&  gaussian_col:shell_col){
                    ...
                    if (lmax_col > 0) {
                        ...
                        for (int i = 1; i < n_orbitals[lmax_row]; i++) {
                            ...
                            olk(i, Cart::x) = PmB(0) * olk(i, 0) + double(nx[i]) * cfak * olk(i_less_x[i], 0);
                            //COMPLEX cny = (ny[i] * fak, 0.0);
                            olk(i, Cart::y) = PmB(1) * olk(i, 0) + double(ny[i]) * cfak * olk(i_less_y[i], 0);
                            //COMPLEX cnz = (nz[i] * fak, 0.0);
                            olk(i, Cart::z) = PmB(2) * olk(i, 0) + double(nz[i]) * cfak * olk(i_less_z[i], 0);
                        }
                        //------------------------------------------------------
                    ...
                    if (lmax_col > 1) {
                        ...
                        for (int i = 1; i < n_orbitals[lmax_row]; i++) {
                            ...
                            olk(i, Cart::xx) = PmB(0) * olk(i, Cart::x) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::x) + term;
                            olk(i, Cart::xy) = PmB(0) * olk(i, Cart::y) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::y);
                            olk(i, Cart::xz) = PmB(0) * olk(i, Cart::z) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::z);
                            olk(i, Cart::yy) = PmB(1) * olk(i, Cart::y) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::y) + term;
                            olk(i, Cart::yz) = PmB(1) * olk(i, Cart::z) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::z);
                            olk(i, Cart::zz) = PmB(2) * olk(i, Cart::z) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::z) + term;
                        }
                        //------------------------------------------------------
                    ...
                    if (lmax_col > 2) {
                        ...
                        //Integrals     s - W - f
                        olk(0, Cart::xxx) = PmB(0) * olk(0, Cart::xx) + 2.0 * cfak * olk(0, Cart::x);
                        ...
                        olk(0, Cart::yyy) = PmB(1) * olk(0, Cart::yy) + 2.0 * cfak * olk(0, Cart::y);
                        olk(0, Cart::yyz) = PmB(2) * olk(0, Cart::yy);
                        olk(0, Cart::yzz) = PmB(1) * olk(0, Cart::zz);
                        olk(0, Cart::zzz) = PmB(2) * olk(0, Cart::zz) + 2.0 * cfak * olk(0, Cart::z);
                        //------------------------------------------------------
                        ...
                        for (int i = 1; i < n_orbitals[lmax_row]; i++) {
                            ...
                            olk(i, Cart::xxx) = PmB(0) * olk(i, Cart::xx) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::xx) + term_x;
                            olk(i, Cart::xxy) = PmB(1) * olk(i, Cart::xx) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::xx);
                            olk(i, Cart::xxz) = PmB(2) * olk(i, Cart::xx) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::xx);
                            olk(i, Cart::xyy) = PmB(0) * olk(i, Cart::yy) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yy);
                            olk(i, Cart::xyz) = PmB(0) * olk(i, Cart::yz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yz);
                            olk(i, Cart::xzz) = PmB(0) * olk(i, Cart::zz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::zz);
                            olk(i, Cart::yyy) = PmB(1) * olk(i, Cart::yy) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::yy) + term_y;
                            olk(i, Cart::yyz) = PmB(2) * olk(i, Cart::yy) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::yy);
                            olk(i, Cart::yzz) = PmB(1) * olk(i, Cart::zz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::zz);
                            olk(i, Cart::zzz) = PmB(2) * olk(i, Cart::zz) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::zz) + term_z;
                        }
                        //------------------------------------------------------
                    ...
                    if (lmax_col > 3) {
                        ...
                        for (int i = 1; i < n_orbitals[lmax_row]; i++) {
                            ...
                            olk(i, Cart::xxxx) = PmB(0) * olk(i, Cart::xxx) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::xxx) + 3.0 * term_xx;
                            olk(i, Cart::xxxy) = PmB(1) * olk(i, Cart::xxx) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::xxx);
                            olk(i, Cart::xxxz) = PmB(2) * olk(i, Cart::xxx) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::xxx);
                            olk(i, Cart::xxyy) = PmB(0) * olk(i, Cart::xyy) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::xyy) + term_yy;
                            olk(i, Cart::xxyz) = PmB(1) * olk(i, Cart::xxz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::xxz);
                            olk(i, Cart::xxzz) = PmB(0) * olk(i, Cart::xzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::xzz) + term_zz;
                            olk(i, Cart::xyyy) = PmB(0) * olk(i, Cart::yyy) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yyy);
                            olk(i, Cart::xyyz) = PmB(0) * olk(i, Cart::yyz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yyz);
                            olk(i, Cart::xyzz) = PmB(0) * olk(i, Cart::yzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yzz);
                            olk(i, Cart::xzzz) = PmB(0) * olk(i, Cart::zzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::zzz);
                            olk(i, Cart::yyyy) = PmB(1) * olk(i, Cart::yyy) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::yyy) + 3.0 * term_yy;
                            olk(i, Cart::yyyz) = PmB(2) * olk(i, Cart::yyy) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::yyy);
                            olk(i, Cart::yyzz) = PmB(1) * olk(i, Cart::yzz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::yzz) + term_zz;
                            olk(i, Cart::yzzz) = PmB(1) * olk(i, Cart::zzz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::zzz);
                            olk(i, Cart::zzzz) = PmB(2) * olk(i, Cart::zzz) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::zzz) + 3.0 * term_zz;
                        }
                        //------------------------------------------------------
                    ...
                    if (lmax_col > 4) {
                        ...
                        for (int i = 1; i < n_orbitals[lmax_row]; i++) {
                            ...
                            olk(i, Cart::xxxxx) = PmB(0) * olk(i, Cart::xxxx) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::xxxx) + 4.0 * term_xxx;
                            olk(i, Cart::xxxxy) = PmB(1) * olk(i, Cart::xxxx) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::xxxx);
                            olk(i, Cart::xxxxz) = PmB(2) * olk(i, Cart::xxxx) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::xxxx);
                            olk(i, Cart::xxxyy) = PmB(1) * olk(i, Cart::xxxy) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::xxxy) + term_xxx;
                            olk(i, Cart::xxxyz) = PmB(1) * olk(i, Cart::xxxz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::xxxz);
                            olk(i, Cart::xxxzz) = PmB(2) * olk(i, Cart::xxxz) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::xxxz) + term_xxx;
                            olk(i, Cart::xxyyy) = PmB(0) * olk(i, Cart::xyyy) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::xyyy) + term_yyy;
                            olk(i, Cart::xxyyz) = PmB(2) * olk(i, Cart::xxyy) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::xxyy);
                            olk(i, Cart::xxyzz) = PmB(1) * olk(i, Cart::xxzz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::xxzz);
                            olk(i, Cart::xxzzz) = PmB(0) * olk(i, Cart::xzzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::xzzz) + term_zzz;
                            olk(i, Cart::xyyyy) = PmB(0) * olk(i, Cart::yyyy) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yyyy);
                            olk(i, Cart::xyyyz) = PmB(0) * olk(i, Cart::yyyz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yyyz);
                            olk(i, Cart::xyyzz) = PmB(0) * olk(i, Cart::yyzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yyzz);
                            olk(i, Cart::xyzzz) = PmB(0) * olk(i, Cart::yzzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yzzz);
                            olk(i, Cart::xzzzz) = PmB(0) * olk(i, Cart::zzzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::zzzz);
                            olk(i, Cart::yyyyy) = PmB(1) * olk(i, Cart::yyyy) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::yyyy) + 4.0 * term_yyy;
                            olk(i, Cart::yyyyz) = PmB(2) * olk(i, Cart::yyyy) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::yyyy);
                            olk(i, Cart::yyyzz) = PmB(2) * olk(i, Cart::yyyz) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::yyyz) + term_yyy;
                            olk(i, Cart::yyzzz) = PmB(1) * olk(i, Cart::yzzz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::yzzz) + term_zzz;
                            olk(i, Cart::yzzzz) = PmB(1) * olk(i, Cart::zzzz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::zzzz);
                            olk(i, Cart::zzzzz) = PmB(2) * olk(i, Cart::zzzz) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::zzzz) + 4.0 * term_zzz;
                        }
                        //------------------------------------------------------
                    ...
                    if (lmax_col > 5) {
                        ...
                        for (int i = 1; i < n_orbitals[lmax_row]; i++) {
                            ...
                            olk(i, Cart::xxxxxx) = PmB(0) * olk(i, Cart::xxxxx) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::xxxxx) + 5.0 * term_xxxx;
                            olk(i, Cart::xxxxxy) = PmB(1) * olk(i, Cart::xxxxx) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::xxxxx);
                            olk(i, Cart::xxxxxz) = PmB(2) * olk(i, Cart::xxxxx) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::xxxxx);
                            olk(i, Cart::xxxxyy) = PmB(1) * olk(i, Cart::xxxxy) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::xxxxy) + term_xxxx;
                            olk(i, Cart::xxxxyz) = PmB(1) * olk(i, Cart::xxxxz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::xxxxz);
                            olk(i, Cart::xxxxzz) = PmB(2) * olk(i, Cart::xxxxz) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::xxxxz) + term_xxxx;
                            olk(i, Cart::xxxyyy) = PmB(0) * olk(i, Cart::xxyyy) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::xxyyy) + 2.0 * term_xyyy;
                            olk(i, Cart::xxxyyz) = PmB(2) * olk(i, Cart::xxxyy) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::xxxyy);
                            olk(i, Cart::xxxyzz) = PmB(1) * olk(i, Cart::xxxzz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::xxxzz);
                            olk(i, Cart::xxxzzz) = PmB(0) * olk(i, Cart::xxzzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::xxzzz) + 2.0 * term_xzzz;
                            olk(i, Cart::xxyyyy) = PmB(0) * olk(i, Cart::xyyyy) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::xyyyy) + term_yyyy;
                            olk(i, Cart::xxyyyz) = PmB(2) * olk(i, Cart::xxyyy) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::xxyyy);
                            olk(i, Cart::xxyyzz) = PmB(0) * olk(i, Cart::xyyzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::xyyzz) + term_yyzz;
                            olk(i, Cart::xxyzzz) = PmB(1) * olk(i, Cart::xxzzz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::xxzzz);
                            olk(i, Cart::xxzzzz) = PmB(0) * olk(i, Cart::xzzzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::xzzzz) + term_zzzz;
                            olk(i, Cart::xyyyyy) = PmB(0) * olk(i, Cart::yyyyy) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yyyyy);
                            olk(i, Cart::xyyyyz) = PmB(0) * olk(i, Cart::yyyyz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yyyyz);
                            olk(i, Cart::xyyyzz) = PmB(0) * olk(i, Cart::yyyzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yyyzz);
                            olk(i, Cart::xyyzzz) = PmB(0) * olk(i, Cart::yyzzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yyzzz);
                            olk(i, Cart::xyzzzz) = PmB(0) * olk(i, Cart::yzzzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::yzzzz);
                            olk(i, Cart::xzzzzz) = PmB(0) * olk(i, Cart::zzzzz) + double(nx[i]) * cfak * olk(i_less_x[i], Cart::zzzzz);
                            olk(i, Cart::yyyyyy) = PmB(1) * olk(i, Cart::yyyyy) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::yyyyy) + 5.0 * term_yyyy;
                            olk(i, Cart::yyyyyz) = PmB(2) * olk(i, Cart::yyyyy) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::yyyyy);
                            olk(i, Cart::yyyyzz) = PmB(2) * olk(i, Cart::yyyyz) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::yyyyz) + term_yyyy;
                            olk(i, Cart::yyyzzz) = PmB(1) * olk(i, Cart::yyzzz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::yyzzz) + 2.0 * term_yzzz;
                            olk(i, Cart::yyzzzz) = PmB(1) * olk(i, Cart::yzzzz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::yzzzz) + term_zzzz;
                            olk(i, Cart::yzzzzz) = PmB(1) * olk(i, Cart::zzzzz) + double(ny[i]) * cfak * olk(i_less_y[i], Cart::zzzzz);
                            olk(i, Cart::zzzzzz) = PmB(2) * olk(i, Cart::zzzzz) + double(nz[i]) * cfak * olk(i_less_z[i], Cart::zzzzz) + 5.0 * term_zzzz;
                        }
                        //------------------------------------------------------
