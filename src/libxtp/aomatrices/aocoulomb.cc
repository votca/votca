  ...
  for (const auto& gaussian_row : shell_row) {
    ...
    for (const auto& gaussian_col : shell_col) {
      ...
      if (lmax_row > 1) {
        ...
        for (int i = 0; i < ncols; i++) {
          cou_tmp(4, i) =
              factor_1 * (2.0 * coumat(Cart::zz, i) - coumat(Cart::xx, i) -
                          coumat(Cart::yy, i));               /// d3z2-r2  Y 2,0
          ...
          cou_tmp(8, i) = factor * (coumat(Cart::xx, i) -
                                    coumat(Cart::yy, i));  /// dx2-y2  Y 2,2
        }
      }
      ...
      if (lmax_row > 2) {
        ...
        for (int i = 0; i < ncols; i++) {
          cou_tmp(9, i) = factor_1 * (2. * coumat(Cart::zzz, i) -
                                      3. * coumat(Cart::xxz, i) -
                                      3. * coumat(Cart::yyz, i));  /// Y 3,0
          cou_tmp(10, i) =
              factor_2 * (4. * coumat(Cart::yzz, i) - coumat(Cart::xxy, i) -
                          coumat(Cart::yyy, i));  /// Y 3,-1
          cou_tmp(11, i) =
              factor_2 * (4. * coumat(Cart::xzz, i) - coumat(Cart::xxx, i) -
                          coumat(Cart::xyy, i));                /// Y 3,1
          cou_tmp(12, i) = 4. * factor * coumat(Cart::xyz, i);  /// Y 3,-2
          cou_tmp(13, i) =
              2. * factor *
              (coumat(Cart::xxz, i) - coumat(Cart::yyz, i));  /// Y 3,2
          cou_tmp(14, i) = factor_3 * (3. * coumat(Cart::xxy, i) -
                                       coumat(Cart::yyy, i));  /// Y 3,-3
          cou_tmp(15, i) = factor_3 * (coumat(Cart::xxx, i) -
                                       3. * coumat(Cart::xyy, i));  /// Y 3,3
        }
      }
      ...
      if (lmax_row > 3) {
        ...
        for (int i = 0; i < ncols; i++) {
          cou_tmp(16, i) =
              factor_1 *
              (3. * (coumat(Cart::xxxx, i) + coumat(Cart::yyyy, i)) +
               6. * coumat(Cart::xxyy, i) -
               24. * (coumat(Cart::xxzz, i) + coumat(Cart::yyzz, i)) +
               8. * coumat(Cart::zzzz, i));  /// Y 4,0
          cou_tmp(17, i) =
              factor_2 *
              (-3. * (coumat(Cart::xxyz, i) + coumat(Cart::yyyz, i)) +
               4. * coumat(Cart::yzzz, i));  /// Y 4,-1
          cou_tmp(18, i) =
              factor_2 *
              (-3. * (coumat(Cart::xxxz, i) + coumat(Cart::xyyz, i)) +
               4. * coumat(Cart::xzzz, i));  /// Y 4,1
          cou_tmp(19, i) = 2. * factor_3 *
                           (-coumat(Cart::xxxy, i) - coumat(Cart::xyyy, i) +
                            6. * coumat(Cart::xyzz, i));  /// Y 4,-2
          cou_tmp(20, i) =
              factor_3 * (-coumat(Cart::xxxx, i) +
          ...
          cou_tmp(23, i) =
              4. * factor *
              (coumat(Cart::xxxy, i) - coumat(Cart::xyyy, i));  /// Y 4,-4
          cou_tmp(24, i) =
              factor * (coumat(Cart::xxxx, i) - 6. * coumat(Cart::xxyy, i) +
      ...
      if (lmax_row > 4) {
        ...
        for (int i = 0; i < ncols; i++) {
          cou_tmp(25, i) =
              factor_1 *
              (15. * (coumat(Cart::xxxxz, i) + coumat(Cart::yyyyz, i)) +
          ...
          cou_tmp(26, i) =
              factor_2 *
              (coumat(Cart::xxxxy, i) + 2. * coumat(Cart::xxyyy, i) -
          ...
          cou_tmp(27, i) =
              factor_2 *
              (coumat(Cart::xxxxx, i) + 2. * coumat(Cart::xxxyy, i) -
               12. * (coumat(Cart::xxxzz, i) + coumat(Cart::xyyzz, i)) +
               coumat(Cart::xyyyy, i) + 8. * coumat(Cart::xzzzz, i));  /// Y 5,1

          cou_tmp(28, i) = 8. * factor *
                           (-coumat(Cart::xxxyz, i) - coumat(Cart::xyyyz, i) +
          ...
          cou_tmp(30, i) =
              factor_3 *
              (-3. * coumat(Cart::xxxxy, i) - 2. * coumat(Cart::xxyyy, i) +
               24. * coumat(Cart::xxyzz, i) + coumat(Cart::yyyyy, i) -
               8. * coumat(Cart::yyyzz, i));  /// Y 5,-3

          cou_tmp(31, i) =
              factor_3 *
              (-coumat(Cart::xxxxx, i) + 2. * coumat(Cart::xxxyy, i) +
               8. * coumat(Cart::xxxzz, i) + 3. * coumat(Cart::xyyyy, i) -
               24. * coumat(Cart::xyyzz, i));  /// Y 5,3

          cou_tmp(32, i) =
              4. * factor_4 *
              (coumat(Cart::xxxyz, i) - coumat(Cart::xyyyz, i));  /// Y 5,-4

          cou_tmp(33, i) =
              factor_4 * (coumat(Cart::xxxxz, i) - 6. * coumat(Cart::xxyyz, i) +
      ...
      if (lmax_row > 5) {
        // i-functions
        factor =
            (2. / 3.) * decay_row * decay_row * decay_row * contractions_row[6];
        ...
        for (int i = 0; i < ncols; i++) {
          cou_tmp(36, i) =
              factor_1 *
              (-5. * (coumat(Cart::xxxxxx, i) + coumat(Cart::yyyyyy, i)) -
          ...
          cou_tmp(37, i) =
              factor_2 *
              (5. * (coumat(Cart::xxxxyz, i) + coumat(Cart::yyyyyz, i)) +
          ...
          cou_tmp(38, i) =
              factor_2 *
              (5. * (coumat(Cart::xxxxxz, i) + coumat(Cart::xyyyyz, i)) +
          ...
          cou_tmp(39, i) =
              2. * factor_3 *
              (coumat(Cart::xxxxxy, i) + 2. * coumat(Cart::xxxyyy, i) -
               16. * (coumat(Cart::xxxyzz, i) + coumat(Cart::xyyyzz, i) -
                      coumat(Cart::xyzzzz, i)) +
               coumat(Cart::xyyyyy, i));  /// Y 6,-2

          cou_tmp(40, i) =
              factor_3 *
              (coumat(Cart::xxxxxy, i) + coumat(Cart::xxxxyy, i) -
               16. * (coumat(Cart::xxxxzz, i) - coumat(Cart::xxzzzz, i) -
                      coumat(Cart::yyyyzz, i) + coumat(Cart::yyzzzz, i)) -
               coumat(Cart::xxyyyy, i) - coumat(Cart::yyyyyy, i));  /// Y 6,2

          cou_tmp(41, i) =
              2. * factor_3 *
              (-9. * coumat(Cart::xxxxyz, i) - 6. * coumat(Cart::xxyyyz, i) +
               24. * coumat(Cart::xxyzzz, i) + 3. * coumat(Cart::yyyyyz, i) -
               8. * coumat(Cart::yyyzzz, i));  /// Y 6,-3

          cou_tmp(42, i) =
              2. * factor_3 *
              (-3. * coumat(Cart::xxxxxz, i) + 6. * coumat(Cart::xxxyyz, i) +
               8. * coumat(Cart::xxxzzz, i) + 9. * coumat(Cart::xyyyyz, i) -
               24. * coumat(Cart::xyyzzz, i));  /// Y 6,3

          cou_tmp(43, i) =
              4. * factor_4 *
              (-coumat(Cart::xxxxxy, i) +
               10. * (coumat(Cart::xxxyzz, i) - coumat(Cart::xyyyzz, i)) +
               coumat(Cart::xyyyyy, i));  /// Y 6,-4

          cou_tmp(44, i) =
              factor_4 *
              (-coumat(Cart::xxxxxx, i) +
          ...
          cou_tmp(47, i) =
              2. * factor_6 *
              (3. * coumat(Cart::xxxxxy, i) - 10. * coumat(Cart::xxxyyy, i) +
      ...
      Eigen::MatrixXd cou_sph = Eigen::MatrixXd::Zero(
          ntrafo_row, ntrafo_col);  ////////////////////////////////////
      ...
      if (lmax_col > 1) {
        ...
        for (int i = 0; i < ntrafo_row; i++) {
          cou_sph(i, 4) =
              factor_1 * (2.0 * cou_tmp(i, Cart::zz) - cou_tmp(i, Cart::xx) -
                          cou_tmp(i, Cart::yy));  /// d3z2-r2  Y 2,0
          ...
          cou_sph(i, 8) = factor * (cou_tmp(i, Cart::xx) -
                                    cou_tmp(i, Cart::yy));  /// dx2-y2  Y 2,2
        }
      }
      ...
      if (lmax_col > 2) {
        ...
        double factor_3 = factor * sqrt(2.) / sqrt(3.);
        for (int i = 0; i < ntrafo_row; i++) {
          cou_sph(i, 9) = factor_1 * (2. * cou_tmp(i, Cart::zzz) -
                                      3. * cou_tmp(i, Cart::xxz) -
                                      3. * cou_tmp(i, Cart::yyz));  /// Y 3,0
          cou_sph(i, 10) =
              factor_2 * (4. * cou_tmp(i, Cart::yzz) - cou_tmp(i, Cart::xxy) -
                          cou_tmp(i, Cart::yyy));  /// Y 3,-1
          cou_sph(i, 11) =
              factor_2 * (4. * cou_tmp(i, Cart::xzz) - cou_tmp(i, Cart::xxx) -
                          cou_tmp(i, Cart::xyy));                /// Y 3,1
          cou_sph(i, 12) = 4. * factor * cou_tmp(i, Cart::xyz);  /// Y 3,-2
          cou_sph(i, 13) =
              2. * factor *
              (cou_tmp(i, Cart::xxz) - cou_tmp(i, Cart::yyz));  /// Y 3,2
          cou_sph(i, 14) = factor_3 * (3. * cou_tmp(i, Cart::xxy) -
                                       cou_tmp(i, Cart::yyy));  /// Y 3,-3
          cou_sph(i, 15) = factor_3 * (cou_tmp(i, Cart::xxx) -
                                       3. * cou_tmp(i, Cart::xyy));  /// Y 3,3
        }
      }
      ...
      if (lmax_col > 3) {
        ...
        for (int i = 0; i < ntrafo_row; i++) {
          cou_sph(i, 16) =
              factor_1 *
              (3. * (cou_tmp(i, Cart::xxxx) + cou_tmp(i, Cart::yyyy)) +
               6. * cou_tmp(i, Cart::xxyy) -
               24. * (cou_tmp(i, Cart::xxzz) + cou_tmp(i, Cart::yyzz)) +
               8. * cou_tmp(i, Cart::zzzz));  /// Y 4,0
          cou_sph(i, 17) =
              factor_2 *
              (-3. * (cou_tmp(i, Cart::xxyz) + cou_tmp(i, Cart::yyyz)) +
               4. * cou_tmp(i, Cart::yzzz));  /// Y 4,-1
          cou_sph(i, 18) =
              factor_2 *
              (-3. * (cou_tmp(i, Cart::xxxz) + cou_tmp(i, Cart::xyyz)) +
               4. * cou_tmp(i, Cart::xzzz));  /// Y 4,1
          cou_sph(i, 19) = 2. * factor_3 *
                           (-cou_tmp(i, Cart::xxxy) - cou_tmp(i, Cart::xyyy) +
          ...
          cou_sph(i, 23) =
              4. * factor *
              (cou_tmp(i, Cart::xxxy) - cou_tmp(i, Cart::xyyy));  /// Y 4,-4
          cou_sph(i, 24) =
              factor * (cou_tmp(i, Cart::xxxx) - 6. * cou_tmp(i, Cart::xxyy) +
      ...
      if (lmax_col > 4) {
        ...
        for (int i = 0; i < ntrafo_row; i++) {
          cou_sph(i, 25) =
              factor_1 *
              (15. * (cou_tmp(i, Cart::xxxxz) + cou_tmp(i, Cart::yyyyz)) +
          ...
          cou_sph(i, 26) =
              factor_2 *
              (cou_tmp(i, Cart::xxxxy) + 2. * cou_tmp(i, Cart::xxyyy) -
          ...
          cou_sph(i, 27) =
              factor_2 *
              (cou_tmp(i, Cart::xxxxx) + 2. * cou_tmp(i, Cart::xxxyy) -
               12. * (cou_tmp(i, Cart::xxxzz) + cou_tmp(i, Cart::xyyzz)) +
               cou_tmp(i, Cart::xyyyy) +
               8. * cou_tmp(i, Cart::xzzzz));  /// Y 5,1

          cou_sph(i, 28) = 8. * factor *
                           (-cou_tmp(i, Cart::xxxyz) - cou_tmp(i, Cart::xyyyz) +
                            2. * cou_tmp(i, Cart::xyzzz));  /// Y 5,-2

          cou_sph(i, 29) =
              4. * factor *
              (-cou_tmp(i, Cart::xxxxz) +
               2. * (cou_tmp(i, Cart::xxzzz) - cou_tmp(i, Cart::yyzzz)) +
               cou_tmp(i, Cart::yyyyz));  /// Y 5,2

          cou_sph(i, 30) =
              factor_3 *
              (-3. * cou_tmp(i, Cart::xxxxy) - 2. * cou_tmp(i, Cart::xxyyy) +
               24. * cou_tmp(i, Cart::xxyzz) + cou_tmp(i, Cart::yyyyy) -
               8. * cou_tmp(i, Cart::yyyzz));  /// Y 5,-3

          cou_sph(i, 31) =
              factor_3 *
              (-cou_tmp(i, Cart::xxxxx) + 2. * cou_tmp(i, Cart::xxxyy) +
               8. * cou_tmp(i, Cart::xxxzz) + 3. * cou_tmp(i, Cart::xyyyy) -
               24. * cou_tmp(i, Cart::xyyzz));  /// Y 5,3

          cou_sph(i, 32) =
              4. * factor_4 *
              (cou_tmp(i, Cart::xxxyz) - cou_tmp(i, Cart::xyyyz));  /// Y 5,-4
      ...
      if (lmax_col > 5) {
        // i-functions
        factor =
            (2. / 3.) * decay_col * decay_col * decay_col * contractions_col[6];
        double factor_1 = factor * 2. / sqrt(1155.);
        double factor_2 = factor * 4. / sqrt(55.);
        double factor_3 = factor * sqrt(22.) / 11.;
        double factor_4 = factor * 2. * sqrt(165.) / 55.;
        ...
        for (int i = 0; i < ntrafo_row; i++) {
          cou_sph(i, 36) =
              factor_1 *
              (-5. * (cou_tmp(i, Cart::xxxxxx) + cou_tmp(i, Cart::yyyyyy)) -
          ...
          cou_sph(i, 37) =
              factor_2 *
              (5. * (cou_tmp(i, Cart::xxxxyz) + cou_tmp(i, Cart::yyyyyz)) +
          ...
          cou_sph(i, 38) =
              factor_2 *
              (5. * (cou_tmp(i, Cart::xxxxxz) + cou_tmp(i, Cart::xyyyyz)) +
          ...
          cou_sph(i, 39) =
              2. * factor_3 *
              (cou_tmp(i, Cart::xxxxxy) + 2. * cou_tmp(i, Cart::xxxyyy) -
               16. * (cou_tmp(i, Cart::xxxyzz) + cou_tmp(i, Cart::xyyyzz) -
                      cou_tmp(i, Cart::xyzzzz)) +
               cou_tmp(i, Cart::xyyyyy));  /// Y 6,-2

          cou_sph(i, 40) =
              factor_3 *
              (cou_tmp(i, Cart::xxxxxy) + cou_tmp(i, Cart::xxxxyy) -
               16. * (cou_tmp(i, Cart::xxxxzz) - cou_tmp(i, Cart::xxzzzz) -
                      cou_tmp(i, Cart::yyyyzz) + cou_tmp(i, Cart::yyzzzz)) -
               cou_tmp(i, Cart::xxyyyy) - cou_tmp(i, Cart::yyyyyy));  /// Y 6,2

          cou_sph(i, 41) =
              2. * factor_3 *
              (-9. * cou_tmp(i, Cart::xxxxyz) - 6. * cou_tmp(i, Cart::xxyyyz) +
               24. * cou_tmp(i, Cart::xxyzzz) + 3. * cou_tmp(i, Cart::yyyyyz) -
               8. * cou_tmp(i, Cart::yyyzzz));  /// Y 6,-3

          cou_sph(i, 42) =
              2. * factor_3 *
              (-3. * cou_tmp(i, Cart::xxxxxz) + 6. * cou_tmp(i, Cart::xxxyyz) +
               8. * cou_tmp(i, Cart::xxxzzz) + 9. * cou_tmp(i, Cart::xyyyyz) -
               24. * cou_tmp(i, Cart::xyyzzz));  /// Y 6,3

          cou_sph(i, 43) =
              4. * factor_4 *
              (-cou_tmp(i, Cart::xxxxxy) +
               10. * (cou_tmp(i, Cart::xxxyzz) - cou_tmp(i, Cart::xyyyzz)) +
               cou_tmp(i, Cart::xyyyyy));  /// Y 6,-4

          cou_sph(i, 44) =
              factor_4 *
              (-cou_tmp(i, Cart::xxxxxx) +
          ...
          cou_sph(i, 46) =
              factor_5 *
              (cou_tmp(i, Cart::xxxxxz) - 10. * cou_tmp(i, Cart::xxxyyz) +
               5. * cou_tmp(i, Cart::xyyyyz));  /// Y 6,5

          cou_sph(i, 47) =
              2. * factor_6 *
              (3. * cou_tmp(i, Cart::xxxxxy) - 10. * cou_tmp(i, Cart::xxxyyy) +
