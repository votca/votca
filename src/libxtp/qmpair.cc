...
void QMPair::SetupCptTable(CptTable& table) const {
  ...
  table.addCol(_lambda0.getValue(QMStateType::statetype::Electron), "lambda0e",
               HOFFSET(data, lambda0e));
  table.addCol(_lambda0.getValue(QMStateType::statetype::Hole), "lambda0h",
               HOFFSET(data, lambda0h));
  table.addCol(_lambda0.getValue(QMStateType::statetype::Singlet), "lambda0s",
               HOFFSET(data, lambda0s));
  table.addCol(_lambda0.getValue(QMStateType::statetype::Triplet), "lambda0t",
               HOFFSET(data, lambda0t));

  table.addCol(_Jeff2.getValue(QMStateType::statetype::Electron), "jeff2e",
               HOFFSET(data, jeff2e));
  table.addCol(_Jeff2.getValue(QMStateType::statetype::Hole), "jeff2h",
               HOFFSET(data, jeff2h));
  table.addCol(_Jeff2.getValue(QMStateType::statetype::Singlet), "jeff2s",
               HOFFSET(data, jeff2s));
  table.addCol(_Jeff2.getValue(QMStateType::statetype::Triplet), "jeff2t",
               HOFFSET(data, jeff2t));
}
