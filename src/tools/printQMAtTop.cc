...
void help_text(void)
{
    votca::csg::HelpTextHeader("printQMAtTop");
    cout << "Print out two .pdb files with the coarse grained and QM trajectories. Useful for checking list charges\n\n";
}
