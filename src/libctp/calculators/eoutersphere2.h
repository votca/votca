...
public:
   ...
   ~EOutersphere2() { };
    ...
    public:
        ...
        InteractorMod(Topology *top, EOutersphere2 *eo) : _top(top), _eo(eo) {};
    ...
    public:
      ...
      ~PairOpOutersphere();
       ...
       void         EvalSite(Topology *top, QMPair2 *qmpair);
       double       CalcOuter(Topology *top, QMPair2 *qmpair, int state);
