...
BOOST_AUTO_TEST_CASE(equivalence_test) {
  ...
  ReducedEdge ed4(vector<long>{2, 3, 4});
  ReducedEdge ed5(vector<long>{4, 3, 2});
  BOOST_CHECK_EQUAL(ed4, ed5);
  BOOST_CHECK_EQUAL((ed4 == ed), false);

  ReducedEdge ed6(vector<long>{2, 6, 3, 1});
  ReducedEdge ed7(vector<long>{1, 3, 6, 2});
  ...
  ReducedEdge ed8(vector<long>{1, 2, 4, 1});
  ReducedEdge ed9(vector<long>{2, 4, 1, 2});
...
BOOST_AUTO_TEST_CASE(less_test) {
  ...
  ReducedEdge ed6(vector<long>{1, 2, 3});
  BOOST_CHECK_EQUAL(ed1 < ed6, true);

  ReducedEdge ed7(vector<long>{1, 2, 3, 4, 1});
  ReducedEdge ed8(vector<long>{1, 4, 3, 2, 1});
  BOOST_CHECK_EQUAL((ed7 < ed8), false);  // Equal

  ReducedEdge ed9(vector<long>{1, 4, 5, 2, 1});
  BOOST_CHECK_EQUAL((ed7 < ed9), true);

  ReducedEdge ed10(vector<long>{1, 4, 5, 0, 1});
  BOOST_CHECK_EQUAL((ed10 < ed9), true);

  ReducedEdge ed11(vector<long>{1, 0, 5, 2, 1});
