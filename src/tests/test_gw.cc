...
BOOST_AUTO_TEST_CASE(gw_full_QP_grid) {
  ...
  Eigen::VectorXd diag = gw.getGWAResults();
  Eigen::VectorXd diag_ref = Eigen::VectorXd::Zero(17);
  diag_ref << -11.5084, -1.57642, -1.22495, -1.22495, -1.22495, 0.245212,
      -0.432287, 0.307713, -0.432287, 0.843971, 0.103971, 0.843971,
      0.39054, 1.21372, 0.47372, 1.21372, 1.06964;
  bool check_diag = diag_ref.isApprox(diag, 1e-5);
  if (!check_diag) {
    cout << "GW energies" << endl;
    cout << diag << endl;
  ...
  Eigen::MatrixXd offdiag = gw.getHQP();
  Eigen::MatrixXd offdiag_ref = Eigen::MatrixXd::Zero(17, 17);
  offdiag_ref << -11.2343, 0.00377978, 6.74134e-06, 2.10204e-05, -1.65181e-05, 0.00741652,
      3.29575e-05, 0.000201692, 4.34309e-05, -9.6694e-05, 3.2904e-05, 5.58129e-05,
      -0.0104043, 0.000120488, -8.63461e-05, -0.000286975, -0.0618723, 0.00377978,
      -1.25102, 8.00715e-05, -1.55633e-05, -0.000145267, 0.000590327, 0.000236422,
      0.00144094, 0.000223225, -0.00195111, -0.000137259, 0.000153, -0.0149631,
      0.00447284, -0.000199204, 0.00281973, 0.0353875, 6.74134e-06, 8.00715e-05,
      -0.492223, 0.00018235, -3.54396e-05, 0.00164606, 0.0201267, -0.00812426,
      -7.45488e-05, -0.000122752, 0.0215046, -0.000226171, -0.00098883, -0.0419305,
      0.00959812, -0.00116103, -0.00130082, 2.10204e-05, -1.55633e-05, 0.00018235,
      -0.492224, 0.000259577, -0.0025894, -0.00767362, -0.0228824, 0.000394379,
      0.00241687, 0.000789286, 0.0358742, 0.00394149, 0.0225864, 0.0273833,
      0.00590089, 0.0019708, -1.65181e-05, -0.000145267, -3.54396e-05, 0.000259577,
      -0.492225, -0.00273779, 0.000246129, 0.000808542, -0.0222349, -0.0344657,
      -0.000254547, -0.00151883, 0.00135412, 0.0032564, -0.00033889, 0.0621347,
      0.00220487, 0.00741652, 0.000590327, 0.00164606, -0.0025894, -0.00273779,
      0.26169, -0.00227193, -0.00452873, -0.00195534, -0.00178723, 0.00085708,
      0.00141276, 0.00572591, -0.00133285, -0.000166973, -0.00399972, 0.0130372,
      3.29575e-05, 0.000236422, 0.0201267, -0.00767362, 0.000246129, -0.00227193,
      0.369387, 0.000232476, 0.000451008, 0.000742284, 0.00243835, -0.000429513,
      0.00172691, -0.0289465, -0.000316118, 0.00143035, 0.00279169, 0.000201692,
      0.00144094, -0.00812426, -0.0228824, 0.000808542, -0.00452873, 0.000232476,
      0.349728, 0.00171758, 0.00024895, -0.00238188, -0.0060267, 0.00168512,
      -0.00334997, -0.0176908, -1.16376e-05, 0.00204317, 4.34309e-05, 0.000223225,
      -7.45488e-05, 0.000394379, -0.0222349, -0.00195534, 0.000451008, 0.00171758,
      0.369387, 0.000444593, -0.000183499, -0.000865817, 0.00215919, 0.0013683,
      2.81312e-05, -0.0392596, 0.0024892, -9.6694e-05, -0.00195111, -0.000122752,
      0.00241687, -0.0344657, -0.00178723, 0.000742284, 0.00024895, 0.000444593,
      0.927042, -0.00109034, 0.00132695, -0.00388893, 0.00303339, -0.000504563,
      0.0548084, -0.00341047, 3.2904e-05, -0.000137259, 0.0215046, 0.000789286,
      -0.000254547, 0.00085708, 0.00243835, -0.00238188, -0.000183499, -0.00109034,
      0.954598, -0.00198308, -0.00182069, 0.0224346, -0.00918373, 0.000909087,
      -0.00109062, 5.58129e-05, 0.000153, -0.000226171, 0.0358742, -0.00151883,
      0.00141276, -0.000429513, -0.0060267, -0.000865817, 0.00132695, -0.00198308,
      0.927042, -0.00107479, -0.0216788, -0.0270326, -0.00464879, 0.00571884,
      -0.0104043, -0.0149631, -0.00098883, 0.00394149, 0.00135412, 0.00572591,
      0.00172691, 0.00168512, 0.00215919, -0.00388893, -0.00182069, -0.00107479,
      1.25008, 0.0098444, -0.00250638, 0.00315124, -0.0157785, 0.000120488,
      0.00447284, -0.0419305, 0.0225864, 0.0032564, -0.00133285, -0.0289465,
      -0.00334997, 0.0013683, 0.00303339, 0.0224346, -0.0216788, 0.0098444,
      1.28422, 0.00849571, -0.00898329, 0.00148124, -8.63461e-05, -0.000199204,
      0.00959812, 0.0273833, -0.00033889, -0.000166973, -0.000316118, -0.0176908,
      2.81312e-05, -0.000504563, -0.00918373, -0.0270326, -0.00250638, 0.00849571,
      1.35591, -0.00725633, 0.00221738, -0.000286975, 0.00281973, -0.00116103,
      0.00590089, 0.0621347, -0.00399972, 0.00143035, -1.16376e-05, -0.0392596,
      0.0548084, 0.000909087, -0.00464879, 0.00315124, -0.00898329, -0.00725633,
      1.28422, 0.00416624, -0.0618723, 0.0353875, -0.00130082, 0.0019708,
      0.00220487, 0.0130372, 0.00279169, 0.00204317, 0.0024892, -0.00341047,
      -0.00109062, 0.00571884, -0.0157785, 0.00148124, 0.00221738, 0.00416624,
      1.88857;
