...
BOOST_AUTO_TEST_CASE(gw_full_QP_grid) {
  ...
  Eigen::VectorXd diag = gw.getGWAResults();
  Eigen::VectorXd diag_ref = Eigen::VectorXd::Zero(17);
  diag_ref << -11.4075, -1.01046, -0.620145, -0.620147, -0.620148, 0.261183,
      0.348342, 0.348343, 0.348342, 0.920829, 0.92083, 0.920829,
      1.18002, 1.27325, 1.27325, 1.27325, 1.96983;
  bool check_diag = diag_ref.isApprox(diag, 1e-5);
  if (!check_diag) {
    cout << "GW energies" << endl;
  ...
  Eigen::MatrixXd offdiag = gw.getHQP();
  Eigen::MatrixXd offdiag_ref = Eigen::MatrixXd::Zero(17, 17);
  offdiag_ref << -11.4075, 0.00399704, -3.08222e-07, -1.505e-07, 3.14887e-08, 0.00818781,
      -2.74296e-07, 3.66471e-07, 2.92777e-08, -1.28313e-07, 1.89668e-07, 7.21242e-08,
      -0.00992935, -1.15011e-06, 2.98987e-07, -9.38581e-07, -0.0624551, 0.00399704,
      -1.01045, -9.92963e-07, -5.74763e-07, 2.63587e-07, 0.00166254, -4.4124e-07,
      6.32908e-07, 2.05667e-07, -3.91867e-07, 4.45519e-07, 3.77088e-07, -0.0109069,
      -2.46171e-06, 6.60487e-07, -2.09296e-06, 0.00211107, -3.08222e-07, -9.92963e-07,
      -0.620145, 2.30344e-07, -8.06292e-07, 1.15697e-07, 0.0204918, -0.00761153,
      8.14677e-05, 9.3978e-05, 0.0227286, -0.000584425, -3.54141e-07, -0.0200228,
      0.00766944, -7.34577e-05, 3.4425e-09, -1.505e-07, -5.74763e-07, 2.30344e-07,
      -0.620146, -7.07623e-07, 3.73733e-08, -0.00761152, -0.0204907, 0.000161773,
      0.000292572, 0.000582961, 0.0227276, -1.0943e-07, 0.00767095, 0.0200208,
      -0.000193121, 4.15085e-08, 3.14887e-08, 2.63587e-07, -8.06292e-07, -7.07623e-07,
      -0.620148, -6.57407e-08, 2.03483e-05, -0.000180345, -0.0218591, -0.0227351,
      0.000102429, 0.000290034, 2.23777e-07, -1.45735e-07, 0.000207514, 0.0214401,
      5.07571e-08, 0.00818781, 0.00166254, 1.15697e-07, 3.73733e-08, -6.57407e-08,
      0.261183, -7.62682e-08, 5.09158e-08, -3.45207e-08, -1.34492e-08, -6.4412e-09,
      -5.30325e-09, 0.00658964, 5.77628e-08, -9.23981e-08, -5.42292e-08, -0.00872951,
      -2.74296e-07, -4.4124e-07, 0.0204918, -0.00761152, 2.03483e-05, -7.62682e-08,
      0.348342, -4.83707e-08, -1.81859e-08, -1.2039e-05, 0.00746312, -0.00299254,
      1.59901e-07, -0.0132173, 0.000134659, 1.1205e-05, 2.96368e-08, 3.66471e-07,
      6.32908e-07, -0.00761153, -0.0204907, -0.000180345, 5.09158e-08, -4.83707e-08,
      0.348343, 5.62396e-08, -4.23719e-05, -0.00299252, -0.00746319, -2.08572e-08,
      -0.00013454, -0.0132174, 1.86631e-05, -2.23895e-08, 2.92777e-08, 2.05667e-07,
      8.14677e-05, 0.000161773, -0.0218591, -3.45207e-08, -1.81859e-08, 5.62396e-08,
      0.348342, 0.00804069, -4.45703e-06, -4.37288e-05, 9.71072e-08, -1.15167e-05,
      -1.85767e-05, -0.0132185, 7.28045e-09, -1.28313e-07, -3.91867e-07, 9.3978e-05,
      0.000292572, -0.0227351, -1.34492e-08, -1.2039e-05, -4.23719e-05, 0.00804069,
      0.920829, 1.3316e-07, 3.1484e-08, -2.68713e-08, -1.54025e-05, -8.48361e-05,
      0.0220706, 5.64641e-08, 1.89668e-07, 4.45519e-07, 0.0227286, 0.000582961,
      0.000102429, -6.4412e-09, 0.00746312, -0.00299252, -4.45703e-06, 1.3316e-07,
      0.920829, 5.87499e-08, 2.23121e-07, 0.0204009, -0.00842208, -1.84939e-05,
      -1.02731e-07, 7.21242e-08, 3.77088e-07, -0.000584425, 0.0227276, 0.000290034,
      -5.30325e-09, -0.00299254, -0.00746319, -4.37288e-05, 3.1484e-08, 5.87499e-08,
      0.920829, 1.21292e-07, -0.00842239, -0.0204004, -8.44338e-05, -6.95175e-08,
      -0.00992935, -0.0109069, -3.54141e-07, -1.0943e-07, 2.23777e-07, 0.00658964,
      1.59901e-07, -2.08572e-08, 9.71072e-08, -2.68713e-08, 2.23121e-07, 1.21292e-07,
      1.18002, -5.16925e-07, 2.27374e-07, -2.91696e-07, -0.0288884, -1.15011e-06,
      -2.46171e-06, -0.0200228, 0.00767095, -1.45735e-07, 5.77628e-08, -0.0132173,
      -0.00013454, -1.15167e-05, -1.54025e-05, 0.0204009, -0.00842239, -5.16925e-07,
      1.27325, -7.36667e-08, 1.37807e-07, 2.35434e-07, 2.98987e-07, 6.60487e-07,
      0.00766944, 0.0200208, 0.000207514, -9.23981e-08, 0.000134659, -0.0132174,
      -1.85767e-05, -8.48361e-05, -0.00842208, -0.0204004, 2.27374e-07, -7.36667e-08,
      1.27325, -4.44339e-08, -4.40486e-08, -9.38581e-07, -2.09296e-06, -7.34577e-05,
      -0.000193121, 0.0214401, -5.42292e-08, 1.1205e-05, 1.86631e-05, -0.0132185,
      0.0220706, -1.84939e-05, -8.44338e-05, -2.91696e-07, 1.37807e-07, -4.44339e-08,
      1.27325, 2.53616e-07, -0.0624551, 0.00211107, 3.4425e-09, 4.15085e-08,
      5.07571e-08, -0.00872951, 2.96368e-08, -2.23895e-08, 7.28045e-09, 5.64641e-08,
      -1.02731e-07, -6.95175e-08, -0.0288884, 2.35434e-07, -4.40486e-08, 2.53616e-07,
      1.96983;
