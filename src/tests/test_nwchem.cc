...
BOOST_AUTO_TEST_CASE(input_generation_version_6_8_1) {
  ...
  defaults << "<package>\n"
           ...
           << "<charge>0</charge>\n"
           << "<spin>1</spin>\n"
           << "<executable>some/path/nwchem</executable>\n"
