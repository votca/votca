...
BOOST_AUTO_TEST_CASE(test_interaction_constructor) {
  Topology top;
  top.CreateInteraction(std::list<votca::Index>{1, 2}, "grp_name", 0,
                        topology_constants::unassigned_molecule_id);
  top.CreateInteraction(std::list<votca::Index>{1, 2, 3}, "grp_name", 1,
                        topology_constants::unassigned_molecule_id);
  top.CreateInteraction(std::list<votca::Index>{1, 2, 3, 4}, "grp_name", 2,
                        topology_constants::unassigned_molecule_id);
}
...
BOOST_AUTO_TEST_CASE(test_interaction_setters_getters) {
  ...
  Topology top;
  const Interaction* bond1 =
      top.CreateInteraction(std::list<votca::Index>{1, 2}, "large", 1, 1);
  ...
  const Interaction* angle1 =
      top.CreateInteraction(std::list<votca::Index>{1, 2, 3}, "medium", 1, 1);
...
BOOST_AUTO_TEST_CASE(bond_test) {
  ...
  bead2->setPos(pos2);
  const Interaction* bond1 =
      top.CreateInteraction(std::list<votca::Index>{0, 1}, "small", 1, 1);
...
BOOST_AUTO_TEST_CASE(angle_test) {
  ...
  const Interaction* angle =
      top.CreateInteraction(std::list<votca::Index>{0, 1, 2}, "small", 1, 1);
...
BOOST_AUTO_TEST_CASE(dihedral_test) {
  ...
  const Interaction* dihedral =
      top.CreateInteraction(std::list<votca::Index>{0, 1, 2, 3}, "small", 1, 1);
