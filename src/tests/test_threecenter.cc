...
Eigen::MatrixXd ref0=Eigen::MatrixXd::Zero(tc[0].cols(),tc[0].rows());
...
Eigen::MatrixXd ref2=Eigen::MatrixXd::Zero(tc[2].cols(),tc[2].rows());
...
Eigen::MatrixXd ref4=Eigen::MatrixXd::Zero(tc[4].cols(),tc[4].rows());
