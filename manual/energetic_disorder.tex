...
\lstinputlisting[
 label=list:estatic, 
 caption={\small part of the \xml file with options for electrostatic energetic disorder. \texttt{method} can be either \texttt{simple} or \texttt{distdep}. In the latter case \texttt{s\_eps} mast be specified.
}]%
