...
Boltzmann-distributed occupations, $p_i \sim \exp(-\Delta E_{ij} / k_\text{B} T)$, can be generated using the \calc{oboltzmann} calculator
\vskip 0.2cm
\label{sec:oboltzmann}
{\noindent \small \ctprun \opt \xmloptions  \seg  \xmlsegments \sql  \sqlstate \exe \calc{oboltzmann} }
...
Site currents and mobility can be obtained using the \calc{vaverage} calculator
\vskip 0.2cm
{\noindent \small \ctprun \opt \xmloptions  \seg  \xmlsegments \sql  \sqlstate \exe \calc{vaverage} }
