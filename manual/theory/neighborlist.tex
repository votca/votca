...
A list of neigboring conjugated segments, or neighbor list\index{neighbor list}, contains all pairs of conjugated segments for which \slink{transfer_integrals}{coupling elements}, \slink{reorganization}{reorganization energies}, \slink{site_energies}{site energy differences}, and \slink{rates}{rates} are evaluated.
