...
In order to visually check the mapping one can use the \calc{tdump} \calculator
\label{sec:tdump}
\votcacommand{Writing a mapped trajectroy}{\small \ctprun \sql \sqlstate \opt \xmloptions \exe \calc{tdump} }
