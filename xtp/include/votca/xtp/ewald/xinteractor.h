...
class XInteractor {
 public:
  ...
  // static const double int2eV = 1/(4*M_PI*8.854187817e-12) * 1.602176487e-19
  // / 1.000e-9;
  ...
  inline void FieldPerm_At_By(APolarSite &pol1, APolarSite &pol2,
                              double &epsilon);
  ...
  inline void FieldIndu_At_By(APolarSite &pol1, APolarSite &pol2,
                              double &epsilon);
  ...
  inline double E_QQ_KK(APolarSite &pol1, APolarSite &pol2, double &ew_alpha,
                        vec &k);
  inline double E_Q0_DQ(APolarSite &pol1, APolarSite &pol2);

  void ResetEnergy() {
    EP = EU_INTER = EU_INTRA = 0.0;
    EPP = EPU = EUU = 0.0;
  }
  ...
  //    &); inline void     FieldIndu12___(vector<PolarSite*> &,
  //    vector<PolarSite*> &); inline void     FieldIndu___21(vector<PolarSite*>
  //    &, vector<PolarSite*> &);
 ...
 private:
  ...
  inline void setLambda7() {
    lambda7 = 1 - (1 + a * u3 + 0.6 * a * a * u3 * u3) * exp(-a * u3);
  }
  inline void setLambda9() {
    lambda9 = 1 - (1 + a * u3 +
                   (18 * a * a * u3 * u3 + 9 * a * a * a * u3 * u3 * u3) / 35) *
                      exp(-a * u3);
  }
  //    inline void setpLambda3() { plambda3 = 1 - exp( -a*u3); }
  //    inline void setpLambda5() { plambda5 = 1 - (1 + a*u3) * exp( -a*u3); }
  //    inline void setpLambda7() { plambda7 = 1 - (1 + a*u3 + 0.6*a*a*u3*u3) *
  //    exp( -a*u3); } inline void setpLambda9() { plambda9 = 1 - (1 + a*u3 +
  //    (18*a*a*u3*u3 + 9*a*a*a*u3*u3*u3)/35) * exp( -a*u3); }
  ...
  inline double T22c_00() {
    return R3 * 0.5 * sqrt(3) * (rax * rax - ray * ray);
  }
  ...
  inline double T00_22c() {
    return R3 * 0.5 * sqrt(3) * (rbx * rbx - rby * rby);
  }
  ...
  inline double TU1x_1x() {
    return R3 * (lambda5 * 3 * rax * rbx + lambda3 * cxx);
  }
  inline double TU1x_1y() {
    return R3 * (lambda5 * 3 * rax * rby + lambda3 * cxy);
  }
  inline double TU1x_1z() {
    return R3 * (lambda5 * 3 * rax * rbz + lambda3 * cxz);
  }
  inline double TU1y_1x() {
    return R3 * (lambda5 * 3 * ray * rbx + lambda3 * cyx);
  }
  inline double TU1y_1y() {
    return R3 * (lambda5 * 3 * ray * rby + lambda3 * cyy);
  }
  inline double TU1y_1z() {
    return R3 * (lambda5 * 3 * ray * rbz + lambda3 * cyz);
  }
  inline double TU1z_1x() {
    return R3 * (lambda5 * 3 * raz * rbx + lambda3 * czx);
  }
  inline double TU1z_1y() {
    return R3 * (lambda5 * 3 * raz * rby + lambda3 * czy);
  }
  inline double TU1z_1z() {
    return R3 * (lambda5 * 3 * raz * rbz + lambda3 * czz);
  }

  inline double pTU1x_1x() {
    return R3 * (plambda5 * 3 * rax * rbx + plambda3 * cxx);
  }
  inline double pTU1x_1y() {
    return R3 * (plambda5 * 3 * rax * rby + plambda3 * cxy);
  }
  inline double pTU1x_1z() {
    return R3 * (plambda5 * 3 * rax * rbz + plambda3 * cxz);
  }
  inline double pTU1y_1x() {
    return R3 * (plambda5 * 3 * ray * rbx + plambda3 * cyx);
  }
  inline double pTU1y_1y() {
    return R3 * (plambda5 * 3 * ray * rby + plambda3 * cyy);
  }
  inline double pTU1y_1z() {
    return R3 * (plambda5 * 3 * ray * rbz + plambda3 * cyz);
  }
  inline double pTU1z_1x() {
    return R3 * (plambda5 * 3 * raz * rbx + plambda3 * czx);
  }
  inline double pTU1z_1y() {
    return R3 * (plambda5 * 3 * raz * rby + plambda3 * czy);
  }
  inline double pTU1z_1z() {
    return R3 * (plambda5 * 3 * raz * rbz + plambda3 * czz);
  }

  inline double T20_1x() {
    return R4 * 0.5 * (15 * raz * raz * rbx + 6 * raz * czx - 3 * rbx);
  }
  inline double T20_1y() {
    return R4 * 0.5 * (15 * raz * raz * rby + 6 * raz * czy - 3 * rby);
  }
  inline double T20_1z() {
    return R4 * 0.5 * (15 * raz * raz * rbz + 6 * raz * czz - 3 * rbz);
  }
  inline double T21c_1x() {
    return R4 * sqrt(3) * (rax * czx + cxx * raz + 5 * rax * raz * rbx);
  }
  inline double T21c_1y() {
    return R4 * sqrt(3) * (rax * czy + cxy * raz + 5 * rax * raz * rby);
  }
  inline double T21c_1z() {
    return R4 * sqrt(3) * (rax * czz + cxz * raz + 5 * rax * raz * rbz);
  }
  inline double T21s_1x() {
    return R4 * sqrt(3) * (ray * czx + cyx * raz + 5 * ray * raz * rbx);
  }
  inline double T21s_1y() {
    return R4 * sqrt(3) * (ray * czy + cyy * raz + 5 * ray * raz * rby);
  }
  inline double T21s_1z() {
    return R4 * sqrt(3) * (ray * czz + cyz * raz + 5 * ray * raz * rbz);
  }
  inline double T22c_1x() {
    return R4 * 0.5 * sqrt(3) *
           (5 * (rax * rax - ray * ray) * rbx + 2 * rax * cxx - 2 * ray * cyx);
  }
  inline double T22c_1y() {
    return R4 * 0.5 * sqrt(3) *
           (5 * (rax * rax - ray * ray) * rby + 2 * rax * cxy - 2 * ray * cyy);
  }
  inline double T22c_1z() {
    return R4 * 0.5 * sqrt(3) *
           (5 * (rax * rax - ray * ray) * rbz + 2 * rax * cxz - 2 * ray * cyz);
  }
  inline double T22s_1x() {
    return R4 * sqrt(3) * (5 * rax * ray * rbx + rax * cyx + ray * cxx);
  }
  inline double T22s_1y() {
    return R4 * sqrt(3) * (5 * rax * ray * rby + rax * cyy + ray * cxy);
  }
  inline double T22s_1z() {
    return R4 * sqrt(3) * (5 * rax * ray * rbz + rax * cyz + ray * cxz);
  }

  inline double T1x_20() {
    return R4 * 0.5 * (15 * rbz * rbz * rax + 6 * rbz * cxz - 3 * rax);
  }
  inline double T1y_20() {
    return R4 * 0.5 * (15 * rbz * rbz * ray + 6 * rbz * cyz - 3 * ray);
  }
  inline double T1z_20() {
    return R4 * 0.5 * (15 * rbz * rbz * raz + 6 * rbz * czz - 3 * raz);
  }
  inline double T1x_21c() {
    return R4 * sqrt(3) * (rbx * cxz + cxx * rbz + 5 * rbx * rbz * rax);
  }
  inline double T1y_21c() {
    return R4 * sqrt(3) * (rbx * cyz + cyx * rbz + 5 * rbx * rbz * ray);
  }
  inline double T1z_21c() {
    return R4 * sqrt(3) * (rbx * czz + czx * rbz + 5 * rbx * rbz * raz);
  }
  inline double T1x_21s() {
    return R4 * sqrt(3) * (rby * cxz + cxy * rbz + 5 * rby * rbz * rax);
  }
  inline double T1y_21s() {
    return R4 * sqrt(3) * (rby * cyz + cyy * rbz + 5 * rby * rbz * ray);
  }
  inline double T1z_21s() {
    return R4 * sqrt(3) * (rby * czz + czy * rbz + 5 * rby * rbz * raz);
  }
  inline double T1x_22c() {
    return R4 * 0.5 * sqrt(3) *
           (5 * (rbx * rbx - rby * rby) * rax + 2 * rbx * cxx - 2 * rby * cxy);
  }
  inline double T1y_22c() {
    return R4 * 0.5 * sqrt(3) *
           (5 * (rbx * rbx - rby * rby) * ray + 2 * rbx * cyx - 2 * rby * cyy);
  }
  inline double T1z_22c() {
    return R4 * 0.5 * sqrt(3) *
           (5 * (rbx * rbx - rby * rby) * raz + 2 * rbx * czx - 2 * rby * czy);
  }
  inline double T1x_22s() {
    return R4 * sqrt(3) * (5 * rbx * rby * rax + rbx * cxy + rby * cxx);
  }
  inline double T1y_22s() {
    return R4 * sqrt(3) * (5 * rbx * rby * ray + rbx * cyy + rby * cyx);
  }
  inline double T1z_22s() {
    return R4 * sqrt(3) * (5 * rbx * rby * raz + rbx * czy + rby * czx);
  }

  inline double TU20_1x() {
    return R4 * 0.5 *
           (lambda7 * 15 * raz * raz * rbx +
            lambda5 * (6 * raz * czx - 3 * rbx));
  }
  inline double TU20_1y() {
    return R4 * 0.5 *
           (lambda7 * 15 * raz * raz * rby +
            lambda5 * (6 * raz * czy - 3 * rby));
  }
  inline double TU20_1z() {
    return R4 * 0.5 *
           (lambda7 * 15 * raz * raz * rbz +
            lambda5 * (6 * raz * czz - 3 * rbz));
  }
  inline double TU21c_1x() {
    return R4 * sqrt(3) *
           (lambda5 * (rax * czx + cxx * raz) + lambda7 * 5 * rax * raz * rbx);
  }
  inline double TU21c_1y() {
    return R4 * sqrt(3) *
           (lambda5 * (rax * czy + cxy * raz) + lambda7 * 5 * rax * raz * rby);
  }
  inline double TU21c_1z() {
    return R4 * sqrt(3) *
           (lambda5 * (rax * czz + cxz * raz) + lambda7 * 5 * rax * raz * rbz);
  }
  inline double TU21s_1x() {
    return R4 * sqrt(3) *
           (lambda5 * (ray * czx + cyx * raz) + lambda7 * 5 * ray * raz * rbx);
  }
  inline double TU21s_1y() {
    return R4 * sqrt(3) *
           (lambda5 * (ray * czy + cyy * raz) + lambda7 * 5 * ray * raz * rby);
  }
  inline double TU21s_1z() {
    return R4 * sqrt(3) *
           (lambda5 * (ray * czz + cyz * raz) + lambda7 * 5 * ray * raz * rbz);
  }
  inline double TU22c_1x() {
    return R4 * 0.5 * sqrt(3) *
           (lambda7 * 5 * (rax * rax - ray * ray) * rbx +
            lambda5 * (2 * rax * cxx - 2 * ray * cyx));
  }
  inline double TU22c_1y() {
    return R4 * 0.5 * sqrt(3) *
           (lambda7 * 5 * (rax * rax - ray * ray) * rby +
            lambda5 * (2 * rax * cxy - 2 * ray * cyy));
  }
  inline double TU22c_1z() {
    return R4 * 0.5 * sqrt(3) *
           (lambda7 * 5 * (rax * rax - ray * ray) * rbz +
            lambda5 * (2 * rax * cxz - 2 * ray * cyz));
  }
  inline double TU22s_1x() {
    return R4 * sqrt(3) *
           (lambda7 * 5 * rax * ray * rbx + lambda5 * (rax * cyx + ray * cxx));
  }
  inline double TU22s_1y() {
    return R4 * sqrt(3) *
           (lambda7 * 5 * rax * ray * rby + lambda5 * (rax * cyy + ray * cxy));
  }
  inline double TU22s_1z() {
    return R4 * sqrt(3) *
           (lambda7 * 5 * rax * ray * rbz + lambda5 * (rax * cyz + ray * cxz));
  }

  inline double TU1x_20() {
    return R4 * 0.5 *
           (lambda7 * 15 * rbz * rbz * rax +
            lambda5 * (6 * rbz * cxz - 3 * rax));
  }
  inline double TU1y_20() {
    return R4 * 0.5 *
           (lambda7 * 15 * rbz * rbz * ray +
            lambda5 * (6 * rbz * cyz - 3 * ray));
  }
  inline double TU1z_20() {
    return R4 * 0.5 *
           (lambda7 * 15 * rbz * rbz * raz +
            lambda5 * (6 * rbz * czz - 3 * raz));
  }
  inline double TU1x_21c() {
    return R4 * sqrt(3) *
           (lambda5 * (rbx * cxz + cxx * rbz) + lambda7 * 5 * rbx * rbz * rax);
  }
  inline double TU1y_21c() {
    return R4 * sqrt(3) *
           (lambda5 * (rbx * cyz + cyx * rbz) + lambda7 * 5 * rbx * rbz * ray);
  }
  inline double TU1z_21c() {
    return R4 * sqrt(3) *
           (lambda5 * (rbx * czz + czx * rbz) + lambda7 * 5 * rbx * rbz * raz);
  }
  inline double TU1x_21s() {
    return R4 * sqrt(3) *
           (lambda5 * (rby * cxz + cxy * rbz) + lambda7 * 5 * rby * rbz * rax);
  }
  inline double TU1y_21s() {
    return R4 * sqrt(3) *
           (lambda5 * (rby * cyz + cyy * rbz) + lambda7 * 5 * rby * rbz * ray);
  }
  inline double TU1z_21s() {
    return R4 * sqrt(3) *
           (lambda5 * (rby * czz + czy * rbz) + lambda7 * 5 * rby * rbz * raz);
  }
  inline double TU1x_22c() {
    return R4 * 0.5 * sqrt(3) *
           (lambda7 * 5 * (rbx * rbx - rby * rby) * rax +
            lambda5 * (2 * rbx * cxx - 2 * rby * cxy));
  }
  inline double TU1y_22c() {
    return R4 * 0.5 * sqrt(3) *
           (lambda7 * 5 * (rbx * rbx - rby * rby) * ray +
            lambda5 * (2 * rbx * cyx - 2 * rby * cyy));
  }
  inline double TU1z_22c() {
    return R4 * 0.5 * sqrt(3) *
           (lambda7 * 5 * (rbx * rbx - rby * rby) * raz +
            lambda5 * (2 * rbx * czx - 2 * rby * czy));
  }
  inline double TU1x_22s() {
    return R4 * sqrt(3) *
           (lambda7 * 5 * rbx * rby * rax + lambda5 * (rbx * cxy + rby * cxx));
  }
  inline double TU1y_22s() {
    return R4 * sqrt(3) *
           (lambda7 * 5 * rbx * rby * ray + lambda5 * (rbx * cyy + rby * cyx));
  }
  inline double TU1z_22s() {
    return R4 * sqrt(3) *
           (lambda7 * 5 * rbx * rby * raz + lambda5 * (rbx * czy + rby * czx));
  }

  inline double pTU20_1x() {
    return R4 * 0.5 *
           (plambda7 * 15 * raz * raz * rbx +
            plambda5 * (6 * raz * czx - 3 * rbx));
  }
  inline double pTU20_1y() {
    return R4 * 0.5 *
           (plambda7 * 15 * raz * raz * rby +
            plambda5 * (6 * raz * czy - 3 * rby));
  }
  inline double pTU20_1z() {
    return R4 * 0.5 *
           (plambda7 * 15 * raz * raz * rbz +
            plambda5 * (6 * raz * czz - 3 * rbz));
  }
  inline double pTU21c_1x() {
    return R4 * sqrt(3) *
           (plambda5 * (rax * czx + cxx * raz) +
            plambda7 * 5 * rax * raz * rbx);
  }
  inline double pTU21c_1y() {
    return R4 * sqrt(3) *
           (plambda5 * (rax * czy + cxy * raz) +
            plambda7 * 5 * rax * raz * rby);
  }
  inline double pTU21c_1z() {
    return R4 * sqrt(3) *
           (plambda5 * (rax * czz + cxz * raz) +
            plambda7 * 5 * rax * raz * rbz);
  }
  inline double pTU21s_1x() {
    return R4 * sqrt(3) *
           (plambda5 * (ray * czx + cyx * raz) +
            plambda7 * 5 * ray * raz * rbx);
  }
  inline double pTU21s_1y() {
    return R4 * sqrt(3) *
           (plambda5 * (ray * czy + cyy * raz) +
            plambda7 * 5 * ray * raz * rby);
  }
  inline double pTU21s_1z() {
    return R4 * sqrt(3) *
           (plambda5 * (ray * czz + cyz * raz) +
            plambda7 * 5 * ray * raz * rbz);
  }
  inline double pTU22c_1x() {
    return R4 * 0.5 * sqrt(3) *
           (plambda7 * 5 * (rax * rax - ray * ray) * rbx +
            plambda5 * (2 * rax * cxx - 2 * ray * cyx));
  }
  inline double pTU22c_1y() {
    return R4 * 0.5 * sqrt(3) *
           (plambda7 * 5 * (rax * rax - ray * ray) * rby +
            plambda5 * (2 * rax * cxy - 2 * ray * cyy));
  }
  inline double pTU22c_1z() {
    return R4 * 0.5 * sqrt(3) *
           (plambda7 * 5 * (rax * rax - ray * ray) * rbz +
            plambda5 * (2 * rax * cxz - 2 * ray * cyz));
  }
  inline double pTU22s_1x() {
    return R4 * sqrt(3) *
           (plambda7 * 5 * rax * ray * rbx +
            plambda5 * (rax * cyx + ray * cxx));
  }
  inline double pTU22s_1y() {
    return R4 * sqrt(3) *
           (plambda7 * 5 * rax * ray * rby +
            plambda5 * (rax * cyy + ray * cxy));
  }
  inline double pTU22s_1z() {
    return R4 * sqrt(3) *
           (plambda7 * 5 * rax * ray * rbz +
            plambda5 * (rax * cyz + ray * cxz));
  }

  inline double pTU1x_20() {
    return R4 * 0.5 *
           (plambda7 * 15 * rbz * rbz * rax +
            plambda5 * (6 * rbz * cxz - 3 * rax));
  }
  inline double pTU1y_20() {
    return R4 * 0.5 *
           (plambda7 * 15 * rbz * rbz * ray +
            plambda5 * (6 * rbz * cyz - 3 * ray));
  }
  inline double pTU1z_20() {
    return R4 * 0.5 *
           (plambda7 * 15 * rbz * rbz * raz +
            plambda5 * (6 * rbz * czz - 3 * raz));
  }
  inline double pTU1x_21c() {
    return R4 * sqrt(3) *
           (plambda5 * (rbx * cxz + cxx * rbz) +
            plambda7 * 5 * rbx * rbz * rax);
  }
  inline double pTU1y_21c() {
    return R4 * sqrt(3) *
           (plambda5 * (rbx * cyz + cyx * rbz) +
            plambda7 * 5 * rbx * rbz * ray);
  }
  inline double pTU1z_21c() {
    return R4 * sqrt(3) *
           (plambda5 * (rbx * czz + czx * rbz) +
            plambda7 * 5 * rbx * rbz * raz);
  }
  inline double pTU1x_21s() {
    return R4 * sqrt(3) *
           (plambda5 * (rby * cxz + cxy * rbz) +
            plambda7 * 5 * rby * rbz * rax);
  }
  inline double pTU1y_21s() {
    return R4 * sqrt(3) *
           (plambda5 * (rby * cyz + cyy * rbz) +
            plambda7 * 5 * rby * rbz * ray);
  }
  inline double pTU1z_21s() {
    return R4 * sqrt(3) *
           (plambda5 * (rby * czz + czy * rbz) +
            plambda7 * 5 * rby * rbz * raz);
  }
  inline double pTU1x_22c() {
    return R4 * 0.5 * sqrt(3) *
           (plambda7 * 5 * (rbx * rbx - rby * rby) * rax +
            plambda5 * (2 * rbx * cxx - 2 * rby * cxy));
  }
  inline double pTU1y_22c() {
    return R4 * 0.5 * sqrt(3) *
           (plambda7 * 5 * (rbx * rbx - rby * rby) * ray +
            plambda5 * (2 * rbx * cyx - 2 * rby * cyy));
  }
  inline double pTU1z_22c() {
    return R4 * 0.5 * sqrt(3) *
           (plambda7 * 5 * (rbx * rbx - rby * rby) * raz +
            plambda5 * (2 * rbx * czx - 2 * rby * czy));
  }
  inline double pTU1x_22s() {
    return R4 * sqrt(3) *
           (plambda7 * 5 * rbx * rby * rax +
            plambda5 * (rbx * cxy + rby * cxx));
  }
  inline double pTU1y_22s() {
    return R4 * sqrt(3) *
           (plambda7 * 5 * rbx * rby * ray +
            plambda5 * (rbx * cyy + rby * cyx));
  }
  inline double pTU1z_22s() {
    return R4 * sqrt(3) *
           (plambda7 * 5 * rbx * rby * raz +
            plambda5 * (rbx * czy + rby * czx));
  }

  inline double T20_20() {
    return R5 * 0.75 *
           (35 * raz * raz * rbz * rbz - 5 * raz * raz - 5 * rbz * rbz +
            20 * raz * rbz * czz + 2 * czz * czz + 1);
  }
  inline double T20_21c() {
    return R5 * 0.5 * sqrt(3) *
           (35 * raz * raz * rbx * rbz - 5 * rbx * rbz + 10 * raz * rbx * czz +
            10 * raz * rbz * czx + 2 * czx * czz);
  }
  inline double T20_21s() {
    return R5 * 0.5 * sqrt(3) *
           (35 * raz * raz * rby * rbz - 5 * rby * rbz + 10 * raz * rby * czz +
            10 * raz * rbz * czy + 2 * czy * czz);
  }
  inline double T20_22c() {
    return R5 * 0.25 * sqrt(3) *
           (35 * raz * raz * rbx * rbx - 35 * raz * raz * rby * rby -
            5 * rbx * rbx + 5 * rby * rby + 20 * raz * rbx * czx -
            20 * raz * rby * czy + 2 * czx * czx - 2 * czy * czy);
  }
  inline double T20_22s() {
    return R5 * 0.5 * sqrt(3) *
           (35 * raz * raz * rbx * rby - 5 * rbx * rby + 10 * raz * rbx * czy +
            10 * raz * rby * czx + 2 * czx * czy);
  }
  inline double T21c_21c() {
    return R5 * (35 * rax * raz * rbx * rbz + 5 * rax * rbx * czz +
                 5 * rax * rbz * czx + 5 * raz * rbx * cxz +
                 5 * raz * rbz * cxx + cxx * czz + cxz * czx);
  }
  inline double T21c_21s() {
    return R5 * (35 * rax * raz * rby * rbz + 5 * rax * rby * czz +
                 5 * rax * rbz * czy + 5 * raz * rby * cxz +
                 5 * raz * rbz * cxy + cxy * czz + cxz * czy);
  }
  inline double T21c_22c() {
    return R5 * 0.5 *
           (35 * rax * raz * rbx * rbx - 35 * rax * raz * rby * rby +
            10 * rax * rbx * czx - 10 * rax * rby * czy + 10 * raz * rbx * cxx -
            10 * raz * rby * cxy + 2 * cxx * czx - 2 * cxy * czy);
  }
  inline double T21c_22s() {
    return R5 * (35 * rax * raz * rbx * rby + 5 * rax * rbx * czy +
                 5 * rax * rby * czx + 5 * raz * rbx * cxy +
                 5 * raz * rby * cxx + cxx * czy + cxy * czx);
  }
  inline double T21s_21s() {
    return R5 * (35 * ray * raz * rby * rbz + 5 * ray * rby * czz +
                 5 * ray * rbz * czy + 5 * raz * rby * cyz +
                 5 * raz * rbz * cyy + cyy * czz + cyz * czy);
  }
  inline double T21s_22c() {
    return R5 * 0.5 *
           (35 * ray * raz * rbx * rbx - 35 * ray * raz * rby * rby +
            10 * ray * rbx * czx - 10 * ray * rby * czy + 10 * raz * rbx * cyx -
            10 * raz * rby * cyy + 2 * cyx * czx - 2 * cyy * czy);
  }
  inline double T21s_22s() {
    return R5 * (35 * ray * raz * rbx * rby + 5 * ray * rbx * czy +
                 5 * ray * rby * czx + 5 * raz * rbx * cyy +
                 5 * raz * rby * cyx + cyx * czy + cyy * czx);
  }
  inline double T22c_22c() {
    return R5 * 0.25 *
           (35 * rax * rax * rbx * rbx - 35 * rax * rax * rby * rby -
            35 * ray * ray * rbx * rbx + 35 * ray * ray * rby * rby +
            20 * rax * rbx * cxx - 20 * rax * rby * cxy - 20 * ray * rbx * cyx +
            20 * ray * rby * cyy + 2 * cxx * cxx - 2 * cxy * cxy -
            2 * cyx * cyx + 2 * cyy * cyy);
  }
  inline double T22c_22s() {
    return R5 * 0.5 *
           (35 * rax * rax * rbx * rby - 35 * ray * ray * rbx * rby +
            10 * rax * rbx * cxy + 10 * rax * rby * cxx - 10 * ray * rbx * cyy -
            10 * ray * rby * cyx + 2 * cxx * cxy - 2 * cyx * cyy);
  }
  inline double T22s_22s() {
    return R5 * (35 * rax * ray * rbx * rby + 5 * rax * rbx * cyy +
                 5 * rax * rby * cyx + 5 * ray * rbx * cxy +
                 5 * ray * rby * cxx + cxx * cyy + cxy * cyx);
  }

  inline double T21c_20() {
    return R5 * 0.5 * sqrt(3) *
           (35 * rbz * rbz * rax * raz - 5 * rax * raz + 10 * rbz * rax * czz +
            10 * rbz * raz * cxz + 2 * cxz * czz);
  }
  inline double T21s_20() {
    return R5 * 0.5 * sqrt(3) *
           (35 * rbz * rbz * ray * raz - 5 * ray * raz + 10 * rbz * ray * czz +
            10 * rbz * raz * cyz + 2 * cyz * czz);
  }
  inline double T22c_20() {
    return R5 * 0.25 * sqrt(3) *
           (35 * rbz * rbz * rax * rax - 35 * rbz * rbz * ray * ray -
            5 * rax * rax + 5 * ray * ray + 20 * rbz * rax * cxz -
            20 * rbz * ray * cyz + 2 * cxz * cxz - 2 * cyz * cyz);
  }
  inline double T22s_20() {
    return R5 * 0.5 * sqrt(3) *
           (35 * rbz * rbz * rax * ray - 5 * rax * ray + 10 * rbz * rax * cyz +
            10 * rbz * ray * cxz + 2 * cxz * cyz);
  }
  inline double T21s_21c() {
    return R5 * (35 * rbx * rbz * ray * raz + 5 * rbx * ray * czz +
                 5 * rbx * raz * cyz + 5 * rbz * ray * czx +
                 5 * rbz * raz * cyx + cyx * czz + czx * cyz);
  }
  inline double T22c_21c() {
    return R5 * 0.5 *
           (35 * rbx * rbz * rax * rax - 35 * rbx * rbz * ray * ray +
            10 * rbx * rax * cxz - 10 * rbx * ray * cyz + 10 * rbz * rax * cxx -
            10 * rbz * ray * cyx + 2 * cxx * cxz - 2 * cyx * cyz);
  }
  inline double T22s_21c() {
    return R5 * (35 * rbx * rbz * rax * ray + 5 * rbx * rax * cyz +
                 5 * rbx * ray * cxz + 5 * rbz * rax * cyx +
                 5 * rbz * ray * cxx + cxx * cyz + cyx * cxz);
  }
  inline double T22c_21s() {
    return R5 * 0.5 *
           (35 * rby * rbz * rax * rax - 35 * rby * rbz * ray * ray +
            10 * rby * rax * cxz - 10 * rby * ray * cyz + 10 * rbz * rax * cxy -
            10 * rbz * ray * cyy + 2 * cxy * cxz - 2 * cyy * cyz);
  }
  inline double T22s_21s() {
    return R5 * (35 * rby * rbz * rax * ray + 5 * rby * rax * cyz +
                 5 * rby * ray * cxz + 5 * rbz * rax * cyy +
                 5 * rbz * ray * cxy + cxy * cyz + cyy * cxz);
  }
  inline double T22s_22c() {
    return R5 * 0.5 *
           (35 * rbx * rbx * rax * ray - 35 * rby * rby * rax * ray +
            10 * rbx * rax * cyx + 10 * rbx * ray * cxx - 10 * rby * rax * cyy -
            10 * rby * ray * cxy + 2 * cxx * cyx - 2 * cxy * cyy);
  }
};
...
inline void XInteractor::PotentialIndu_At_By(APolarSite &pol1,
                                             APolarSite &pol2) {
  // NOTE Calculates potential at <pol1> due to moments on <pol2>
  // NOTE Only potentials generated by induced moments on <pol2> are damped.
  // ATTENTION Call ::BiasIndu before using this method.
...
inline double XInteractor::PotentialPerm(vec r, APolarSite &pol) {
  ...
  rbx = -e12(0);
  rby = -e12(1);  // e12.getX(); <---- WHAT???>
  rbz = -e12(2);  // had getX() too!!!
 ...
 */
inline void XInteractor::FieldIndu_At_By(APolarSite &pol1, APolarSite &pol2,
                                         double &epsilon) {
 ...
 */
inline void XInteractor::FieldPermAsIndu_At_By(APolarSite &pol1,
                                               APolarSite &pol2) {
...
inline void XInteractor::FieldPermAsPerm_At_By(APolarSite &pol1,
                                               APolarSite &pol2) {
 ...
 * NOTE No Thole-type damping applied
 */
inline double XInteractor::EnergyInter_Indu_Perm(APolarSite &pol1,
                                                 APolarSite &pol2) {
...
inline double XInteractor::E_QQ_ERF(APolarSite &pol1, APolarSite &pol2,
                                    double &ew_alpha) {
  e12 = pol2.getPos() - pol1.getPos();
  R = (e12.norm() < 1e-50) ? 1e+50 : 1 / e12.norm();
  return pol1.Q00 * pol2.Q00 * R * erf(ew_alpha / R);
}

inline double XInteractor::E_QQ_K0(APolarSite &pol1, APolarSite &pol2,
                                   double &ew_alpha) {
  // NOTE Without prefactor 2*PI/(Lx*Ly)
  e12 = pol2.getPos() - pol1.getPos();
  double z12 = e12(2);
  return -pol1.Q00 * pol2.Q00 *
         (exp(-ew_alpha * ew_alpha * z12 * z12) / (sqrt(M_PI) * ew_alpha) +
          z12 * erf(ew_alpha * z12));
}

inline double XInteractor::E_QQ_KK(APolarSite &pol1, APolarSite &pol2,
                                   double &ew_alpha, vec &k) {
  // NOTE Without prefactor 2*PI/(Lx*Ly)
  e12 = pol2.getPos() - pol1.getPos();
  double z12 = e12(2);
  double K = k.norm();
  return pol1.Q00 * pol2.Q00 * cos(k.dot(e12)) / K *
...
inline void XInteractor::BiasStat(APolarSite &pol1, APolarSite &pol2) {
  ...
  u3 =
      ...
      (R3 *
       sqrt(1. / 3. *
            (pol1.Pxx * pol2.Pxx + pol1.Pxy * pol2.Pxy + pol1.Pxz * pol2.Pxz +
