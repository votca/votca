...
class Atom {
 public:
  Atom(Molecule *owner, string residue_name, int resnr, string md_atom_name,
       int md_atom_id, bool hasQMPart, int qm_atom_id, vec qmPos,
       string element, double weight)
      : _id(md_atom_id),
        _name(md_atom_name),
        _mol(owner),
        _resnr(resnr),
