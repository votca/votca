...
#pragma once
#ifndef VOTCA_XTP_BACKGROUNDREGION_H
#define VOTCA_XTP_BACKGROUNDREGION_H
...
class BackgroundRegion : public MMRegion<PolarSegment> {
 public:
  BackgroundRegion(Index id, Logger& log) : MMRegion<PolarSegment>(id, log) {}
...
#endif  // VOTCA_XTP_BACKGROUNDREGION_H
