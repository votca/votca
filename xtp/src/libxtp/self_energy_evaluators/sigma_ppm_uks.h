...
#pragma once
#ifndef VOTCA_XTP_SIGMA_PPM_UKS_H
#define VOTCA_XTP_SIGMA_PPM_UKS_H
...
class Sigma_PPM_UKS : public Sigma_base_UKS {
 public:
  Sigma_PPM_UKS(TCMatrix_gwbse_spin& Mmn, RPA_UKS& rpa,
