...
BOOST_AUTO_TEST_CASE(energy_eval_with_induced_dipoles) { BOOST_CHECK(true); }

BOOST_AUTO_TEST_CASE(field_eval_with_induced_dipoles) { BOOST_CHECK(true); }

BOOST_AUTO_TEST_CASE(background_polarization) { BOOST_CHECK(true); }
