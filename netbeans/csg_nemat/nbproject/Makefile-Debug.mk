...
LDLIBSOPTIONS=-L/people/thnfs/homes/ruehle/gmx/lib ../libcsg/../../src/libcsg/libcsg.a ../../../tools/netbeans/libtools/../../src/libtools/libtools.a -lgmx -lboost_program_options -lfftw3 -lexpat -lm

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk ../../src/tools/csg_nemat

../../src/tools/csg_nemat: ../libcsg/../../src/libcsg/libcsg.a

../../src/tools/csg_nemat: ../../../tools/netbeans/libtools/../../src/libtools/libtools.a
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/tools/csg_nemat.o: nbproject/Makefile-${CND_CONF}.mk ../../src/tools/csg_nemat.cc 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../../../include -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/tools/csg_nemat.o ../../src/tools/csg_nemat.cc
