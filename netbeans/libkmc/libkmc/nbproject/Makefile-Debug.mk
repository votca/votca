...
${OBJECTDIR}/_ext/853823286/kmcapplication.o: ../../../src/libkmc/kmcapplication.cc 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/853823286/kmcapplication.o ../../../src/libkmc/kmcapplication.cc

${OBJECTDIR}/_ext/853823286/kmccalculatorfactory.o: ../../../src/libkmc/kmccalculatorfactory.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/853823286
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/853823286/kmccalculatorfactory.o ../../../src/libkmc/kmccalculatorfactory.cc
