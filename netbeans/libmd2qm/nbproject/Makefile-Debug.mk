...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/libmd2qm/calculatorfactory.o: nbproject/Makefile-${CND_CONF}.mk ../../src/libmd2qm/calculatorfactory.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/libmd2qm
	${RM} $@.d
	$(COMPILE.cc) -g -I../../include -I../../../include -I/usr/include/libxml2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/libmd2qm/calculatorfactory.o ../../src/libmd2qm/calculatorfactory.cc
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/libmd2qm/calculators/shufflenrg.o: nbproject/Makefile-${CND_CONF}.mk ../../src/libmd2qm/calculators/shufflenrg.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/libmd2qm/calculators
	${RM} $@.d
	$(COMPILE.cc) -g -I../../include -I../../../include -I/usr/include/libxml2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/libmd2qm/calculators/shufflenrg.o ../../src/libmd2qm/calculators/shufflenrg.cc
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/libmd2qm/calculators/readxml.o: nbproject/Makefile-${CND_CONF}.mk ../../src/libmd2qm/calculators/readxml.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/libmd2qm/calculators
	${RM} $@.d
	$(COMPILE.cc) -g -I../../include -I../../../include -I/usr/include/libxml2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/libmd2qm/calculators/readxml.o ../../src/libmd2qm/calculators/readxml.cc
