...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/tools/qmapplication.o: nbproject/Makefile-${CND_CONF}.mk ../../src/tools/qmapplication.cc 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../../include -I../../../include -I/usr/include/libxml2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/tools/qmapplication.o ../../src/tools/qmapplication.cc
