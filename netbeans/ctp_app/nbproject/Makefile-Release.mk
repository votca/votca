...
${OBJECTDIR}/_ext/715944016/ctp_app.o: ../../src/tools/ctp_app.cc 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/715944016/ctp_app.o ../../src/tools/ctp_app.cc

${OBJECTDIR}/_ext/484457893/toolfactory.o: ../../src/libctp/toolfactory.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/484457893
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/484457893/toolfactory.o ../../src/libctp/toolfactory.cc
