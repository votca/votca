...
Get the [files](https://github.com/tbereau/plumx/tree/master/dppc_mapping) from the [plumx](https://github.com/tbereau/plumx) project and create a center of geometry/charge mapping. Visualize the result using vmd.
...
The files for the tutorial can be found in `hexane/hybrid_force_matching`. The folder should contain all necessary files to reproduce the plots from the [publication](http://dx.doi.org/10.1002/mats.201100011). Try to understand the input files and reproduce some of the key figures.
